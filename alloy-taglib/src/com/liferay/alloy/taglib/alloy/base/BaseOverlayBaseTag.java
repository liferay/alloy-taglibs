 ...
 * @generated
 */
public abstract class BaseOverlayBaseTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:overlay-base:align", _align);
		request.setAttribute("alloy:overlay-base:alignOn", _alignOn);
		request.setAttribute("alloy:overlay-base:bodyContent", _overlaybaseBodyContent);
		request.setAttribute("alloy:overlay-base:boundingBox", _boundingBox);
		request.setAttribute("alloy:overlay-base:centered", _centered);
		request.setAttribute("alloy:overlay-base:constrain", _constrain);
		request.setAttribute("alloy:overlay-base:contentBox", _contentBox);
		request.setAttribute("alloy:overlay-base:cssClass", _cssClass);
		request.setAttribute("alloy:overlay-base:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:overlay-base:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:overlay-base:fillHeight", _fillHeight);
		request.setAttribute("alloy:overlay-base:focused", String.valueOf(_focused));
		request.setAttribute("alloy:overlay-base:footerContent", _footerContent);
		request.setAttribute("alloy:overlay-base:headerContent", _headerContent);
		request.setAttribute("alloy:overlay-base:height", _height);
		request.setAttribute("alloy:overlay-base:hideClass", _hideClass);
		request.setAttribute("alloy:overlay-base:id", _overlaybaseId);
		request.setAttribute("alloy:overlay-base:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:overlay-base:preventOverlap", String.valueOf(_preventOverlap));
		request.setAttribute("alloy:overlay-base:render", _render);
		request.setAttribute("alloy:overlay-base:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:overlay-base:shim", String.valueOf(_shim));
		request.setAttribute("alloy:overlay-base:srcNode", _srcNode);
		request.setAttribute("alloy:overlay-base:strings", _strings);
		request.setAttribute("alloy:overlay-base:tabIndex", _tabIndex);
		request.setAttribute("alloy:overlay-base:useARIA", String.valueOf(_useARIA));
		request.setAttribute("alloy:overlay-base:visible", String.valueOf(_visible));
		request.setAttribute("alloy:overlay-base:width", _width);
		request.setAttribute("alloy:overlay-base:x", _x);
		request.setAttribute("alloy:overlay-base:xy", _xy);
		request.setAttribute("alloy:overlay-base:y", _y);
		request.setAttribute("alloy:overlay-base:zIndex", _zIndex);
		request.setAttribute("alloy:overlay-base:afterAlignChange", _afterAlignChange);
		request.setAttribute("alloy:overlay-base:afterAlignOnChange", _afterAlignOnChange);
		request.setAttribute("alloy:overlay-base:afterBodyContentChange", _afterBodyContentChange);
		request.setAttribute("alloy:overlay-base:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:overlay-base:afterCenteredChange", _afterCenteredChange);
		request.setAttribute("alloy:overlay-base:afterConstrainChange", _afterConstrainChange);
		request.setAttribute("alloy:overlay-base:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:overlay-base:afterCssClassChange", _afterCssClassChange);
		request.setAttribute("alloy:overlay-base:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:overlay-base:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:overlay-base:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:overlay-base:afterFillHeightChange", _afterFillHeightChange);
		request.setAttribute("alloy:overlay-base:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:overlay-base:afterFooterContentChange", _afterFooterContentChange);
		request.setAttribute("alloy:overlay-base:afterHeaderContentChange", _afterHeaderContentChange);
		request.setAttribute("alloy:overlay-base:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:overlay-base:afterHideClassChange", _afterHideClassChange);
		request.setAttribute("alloy:overlay-base:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:overlay-base:afterInit", _afterInit);
		request.setAttribute("alloy:overlay-base:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:overlay-base:afterPreventOverlapChange", _afterPreventOverlapChange);
		request.setAttribute("alloy:overlay-base:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:overlay-base:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:overlay-base:afterShimChange", _afterShimChange);
		request.setAttribute("alloy:overlay-base:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:overlay-base:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:overlay-base:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:overlay-base:afterUseARIAChange", _afterUseARIAChange);
		request.setAttribute("alloy:overlay-base:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:overlay-base:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:overlay-base:afterRender", _afterRender);
		request.setAttribute("alloy:overlay-base:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:overlay-base:afterXChange", _afterXChange);
		request.setAttribute("alloy:overlay-base:afterXyChange", _afterXyChange);
		request.setAttribute("alloy:overlay-base:afterYChange", _afterYChange);
		request.setAttribute("alloy:overlay-base:afterZIndexChange", _afterZIndexChange);
		request.setAttribute("alloy:overlay-base:onAlignChange", _onAlignChange);
		request.setAttribute("alloy:overlay-base:onAlignOnChange", _onAlignOnChange);
		request.setAttribute("alloy:overlay-base:onBodyContentChange", _onBodyContentChange);
		request.setAttribute("alloy:overlay-base:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:overlay-base:onCenteredChange", _onCenteredChange);
		request.setAttribute("alloy:overlay-base:onConstrainChange", _onConstrainChange);
		request.setAttribute("alloy:overlay-base:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:overlay-base:onCssClassChange", _onCssClassChange);
		request.setAttribute("alloy:overlay-base:onDestroy", _onDestroy);
		request.setAttribute("alloy:overlay-base:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:overlay-base:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:overlay-base:onFillHeightChange", _onFillHeightChange);
		request.setAttribute("alloy:overlay-base:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:overlay-base:onFooterContentChange", _onFooterContentChange);
		request.setAttribute("alloy:overlay-base:onHeaderContentChange", _onHeaderContentChange);
		request.setAttribute("alloy:overlay-base:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:overlay-base:onHideClassChange", _onHideClassChange);
		request.setAttribute("alloy:overlay-base:onIdChange", _onIdChange);
		request.setAttribute("alloy:overlay-base:onInit", _onInit);
		request.setAttribute("alloy:overlay-base:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:overlay-base:onPreventOverlapChange", _onPreventOverlapChange);
		request.setAttribute("alloy:overlay-base:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:overlay-base:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:overlay-base:onShimChange", _onShimChange);
		request.setAttribute("alloy:overlay-base:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:overlay-base:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:overlay-base:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:overlay-base:onUseARIAChange", _onUseARIAChange);
		request.setAttribute("alloy:overlay-base:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:overlay-base:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:overlay-base:onRender", _onRender);
		request.setAttribute("alloy:overlay-base:onWidthChange", _onWidthChange);
		request.setAttribute("alloy:overlay-base:onXChange", _onXChange);
		request.setAttribute("alloy:overlay-base:onXyChange", _onXyChange);
		request.setAttribute("alloy:overlay-base:onYChange", _onYChange);
		request.setAttribute("alloy:overlay-base:onZIndexChange", _onZIndexChange);
	}
