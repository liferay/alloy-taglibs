 ...
 * @generated
 */
public abstract class BaseResizeTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:resize:activeHandle", _activeHandle);
		request.setAttribute("alloy:resize:activeHandleEl", _activeHandleEl);
		request.setAttribute("alloy:resize:activeHandleNode", _activeHandleNode);
		request.setAttribute("alloy:resize:autoHide", String.valueOf(_autoHide));
		request.setAttribute("alloy:resize:constrain", _constrain);
		request.setAttribute("alloy:resize:defMinHeight", _defMinHeight);
		request.setAttribute("alloy:resize:defMinWidth", _defMinWidth);
		request.setAttribute("alloy:resize:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:resize:handles", _handles);
		request.setAttribute("alloy:resize:handlesWrapper", _handlesWrapper);
		request.setAttribute("alloy:resize:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:resize:maxHeight", _maxHeight);
		request.setAttribute("alloy:resize:maxWidth", _maxWidth);
		request.setAttribute("alloy:resize:minHeight", _minHeight);
		request.setAttribute("alloy:resize:minWidth", _minWidth);
		request.setAttribute("alloy:resize:node", _node);
		request.setAttribute("alloy:resize:preserveRatio", String.valueOf(_preserveRatio));
		request.setAttribute("alloy:resize:proxy", String.valueOf(_proxy));
		request.setAttribute("alloy:resize:proxyEl", _proxyEl);
		request.setAttribute("alloy:resize:resizing", String.valueOf(_resizing));
		request.setAttribute("alloy:resize:tickX", _tickX);
		request.setAttribute("alloy:resize:tickY", _tickY);
		request.setAttribute("alloy:resize:wrap", String.valueOf(_wrap));
		request.setAttribute("alloy:resize:wrapTypes", _wrapTypes);
		request.setAttribute("alloy:resize:wrapper", _wrapper);
		request.setAttribute("alloy:resize:afterActiveHandleChange", _afterActiveHandleChange);
		request.setAttribute("alloy:resize:afterActiveHandleElChange", _afterActiveHandleElChange);
		request.setAttribute("alloy:resize:afterActiveHandleNodeChange", _afterActiveHandleNodeChange);
		request.setAttribute("alloy:resize:afterAutoHideChange", _afterAutoHideChange);
		request.setAttribute("alloy:resize:afterConstrainChange", _afterConstrainChange);
		request.setAttribute("alloy:resize:afterDefMinHeightChange", _afterDefMinHeightChange);
		request.setAttribute("alloy:resize:afterDefMinWidthChange", _afterDefMinWidthChange);
		request.setAttribute("alloy:resize:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:resize:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:resize:afterHandlesChange", _afterHandlesChange);
		request.setAttribute("alloy:resize:afterHandlesWrapperChange", _afterHandlesWrapperChange);
		request.setAttribute("alloy:resize:afterInit", _afterInit);
		request.setAttribute("alloy:resize:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:resize:afterMaxHeightChange", _afterMaxHeightChange);
		request.setAttribute("alloy:resize:afterMaxWidthChange", _afterMaxWidthChange);
		request.setAttribute("alloy:resize:afterMinHeightChange", _afterMinHeightChange);
		request.setAttribute("alloy:resize:afterMinWidthChange", _afterMinWidthChange);
		request.setAttribute("alloy:resize:afterNodeChange", _afterNodeChange);
		request.setAttribute("alloy:resize:afterPreserveRatioChange", _afterPreserveRatioChange);
		request.setAttribute("alloy:resize:afterProxyChange", _afterProxyChange);
		request.setAttribute("alloy:resize:afterProxyElChange", _afterProxyElChange);
		request.setAttribute("alloy:resize:afterAlign", _afterAlign);
		request.setAttribute("alloy:resize:afterEnd", _afterEnd);
		request.setAttribute("alloy:resize:afterMouseUp", _afterMouseUp);
		request.setAttribute("alloy:resize:afterResize", _afterResize);
		request.setAttribute("alloy:resize:afterStart", _afterStart);
		request.setAttribute("alloy:resize:afterResizingChange", _afterResizingChange);
		request.setAttribute("alloy:resize:afterTickXChange", _afterTickXChange);
		request.setAttribute("alloy:resize:afterTickYChange", _afterTickYChange);
		request.setAttribute("alloy:resize:afterWrapChange", _afterWrapChange);
		request.setAttribute("alloy:resize:afterWrapTypesChange", _afterWrapTypesChange);
		request.setAttribute("alloy:resize:afterWrapperChange", _afterWrapperChange);
		request.setAttribute("alloy:resize:onActiveHandleChange", _onActiveHandleChange);
		request.setAttribute("alloy:resize:onActiveHandleElChange", _onActiveHandleElChange);
		request.setAttribute("alloy:resize:onActiveHandleNodeChange", _onActiveHandleNodeChange);
		request.setAttribute("alloy:resize:onAutoHideChange", _onAutoHideChange);
		request.setAttribute("alloy:resize:onConstrainChange", _onConstrainChange);
		request.setAttribute("alloy:resize:onDefMinHeightChange", _onDefMinHeightChange);
		request.setAttribute("alloy:resize:onDefMinWidthChange", _onDefMinWidthChange);
		request.setAttribute("alloy:resize:onDestroy", _onDestroy);
		request.setAttribute("alloy:resize:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:resize:onHandlesChange", _onHandlesChange);
		request.setAttribute("alloy:resize:onHandlesWrapperChange", _onHandlesWrapperChange);
		request.setAttribute("alloy:resize:onInit", _onInit);
		request.setAttribute("alloy:resize:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:resize:onMaxHeightChange", _onMaxHeightChange);
		request.setAttribute("alloy:resize:onMaxWidthChange", _onMaxWidthChange);
		request.setAttribute("alloy:resize:onMinHeightChange", _onMinHeightChange);
		request.setAttribute("alloy:resize:onMinWidthChange", _onMinWidthChange);
		request.setAttribute("alloy:resize:onNodeChange", _onNodeChange);
		request.setAttribute("alloy:resize:onPreserveRatioChange", _onPreserveRatioChange);
		request.setAttribute("alloy:resize:onProxyChange", _onProxyChange);
		request.setAttribute("alloy:resize:onProxyElChange", _onProxyElChange);
		request.setAttribute("alloy:resize:onAlign", _onAlign);
		request.setAttribute("alloy:resize:onEnd", _onEnd);
		request.setAttribute("alloy:resize:onMouseUp", _onMouseUp);
		request.setAttribute("alloy:resize:onResize", _onResize);
		request.setAttribute("alloy:resize:onStart", _onStart);
		request.setAttribute("alloy:resize:onResizingChange", _onResizingChange);
		request.setAttribute("alloy:resize:onTickXChange", _onTickXChange);
		request.setAttribute("alloy:resize:onTickYChange", _onTickYChange);
		request.setAttribute("alloy:resize:onWrapChange", _onWrapChange);
		request.setAttribute("alloy:resize:onWrapTypesChange", _onWrapTypesChange);
		request.setAttribute("alloy:resize:onWrapperChange", _onWrapperChange);
	}
