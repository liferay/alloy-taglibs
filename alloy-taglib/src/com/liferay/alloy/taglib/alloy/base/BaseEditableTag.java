 ...
 * @generated
 */
public abstract class BaseEditableTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:editable:boundingBox", _boundingBox);
		request.setAttribute("alloy:editable:cancelButton", _cancelButton);
		request.setAttribute("alloy:editable:contentBox", _contentBox);
		request.setAttribute("alloy:editable:contentText", _contentText);
		request.setAttribute("alloy:editable:cssClass", _cssClass);
		request.setAttribute("alloy:editable:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:editable:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:editable:eventType", _eventType);
		request.setAttribute("alloy:editable:focused", String.valueOf(_focused));
		request.setAttribute("alloy:editable:formatInput", _formatInput);
		request.setAttribute("alloy:editable:formatOutput", _formatOutput);
		request.setAttribute("alloy:editable:height", _height);
		request.setAttribute("alloy:editable:hideClass", _hideClass);
		request.setAttribute("alloy:editable:icons", _icons);
		request.setAttribute("alloy:editable:id", _editableId);
		request.setAttribute("alloy:editable:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:editable:inputType", _inputType);
		request.setAttribute("alloy:editable:node", _node);
		request.setAttribute("alloy:editable:render", _render);
		request.setAttribute("alloy:editable:renderTo", _renderTo);
		request.setAttribute("alloy:editable:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:editable:saveButton", _saveButton);
		request.setAttribute("alloy:editable:srcNode", _srcNode);
		request.setAttribute("alloy:editable:strings", _strings);
		request.setAttribute("alloy:editable:tabIndex", _tabIndex);
		request.setAttribute("alloy:editable:useARIA", String.valueOf(_useARIA));
		request.setAttribute("alloy:editable:visible", String.valueOf(_visible));
		request.setAttribute("alloy:editable:width", _width);
		request.setAttribute("alloy:editable:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:editable:afterCancel", _afterCancel);
		request.setAttribute("alloy:editable:afterCancelButtonChange", _afterCancelButtonChange);
		request.setAttribute("alloy:editable:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:editable:afterContentTextChange", _afterContentTextChange);
		request.setAttribute("alloy:editable:afterCssClassChange", _afterCssClassChange);
		request.setAttribute("alloy:editable:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:editable:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:editable:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:editable:afterEventTypeChange", _afterEventTypeChange);
		request.setAttribute("alloy:editable:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:editable:afterFormatInputChange", _afterFormatInputChange);
		request.setAttribute("alloy:editable:afterFormatOutputChange", _afterFormatOutputChange);
		request.setAttribute("alloy:editable:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:editable:afterHideClassChange", _afterHideClassChange);
		request.setAttribute("alloy:editable:afterIconsChange", _afterIconsChange);
		request.setAttribute("alloy:editable:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:editable:afterInit", _afterInit);
		request.setAttribute("alloy:editable:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:editable:afterInputTypeChange", _afterInputTypeChange);
		request.setAttribute("alloy:editable:afterNodeChange", _afterNodeChange);
		request.setAttribute("alloy:editable:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:editable:afterRenderToChange", _afterRenderToChange);
		request.setAttribute("alloy:editable:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:editable:afterSave", _afterSave);
		request.setAttribute("alloy:editable:afterSaveButtonChange", _afterSaveButtonChange);
		request.setAttribute("alloy:editable:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:editable:afterStartEditing", _afterStartEditing);
		request.setAttribute("alloy:editable:afterStopEditing", _afterStopEditing);
		request.setAttribute("alloy:editable:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:editable:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:editable:afterUseARIAChange", _afterUseARIAChange);
		request.setAttribute("alloy:editable:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:editable:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:editable:afterRender", _afterRender);
		request.setAttribute("alloy:editable:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:editable:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:editable:onCancel", _onCancel);
		request.setAttribute("alloy:editable:onCancelButtonChange", _onCancelButtonChange);
		request.setAttribute("alloy:editable:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:editable:onContentTextChange", _onContentTextChange);
		request.setAttribute("alloy:editable:onCssClassChange", _onCssClassChange);
		request.setAttribute("alloy:editable:onDestroy", _onDestroy);
		request.setAttribute("alloy:editable:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:editable:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:editable:onEventTypeChange", _onEventTypeChange);
		request.setAttribute("alloy:editable:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:editable:onFormatInputChange", _onFormatInputChange);
		request.setAttribute("alloy:editable:onFormatOutputChange", _onFormatOutputChange);
		request.setAttribute("alloy:editable:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:editable:onHideClassChange", _onHideClassChange);
		request.setAttribute("alloy:editable:onIconsChange", _onIconsChange);
		request.setAttribute("alloy:editable:onIdChange", _onIdChange);
		request.setAttribute("alloy:editable:onInit", _onInit);
		request.setAttribute("alloy:editable:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:editable:onInputTypeChange", _onInputTypeChange);
		request.setAttribute("alloy:editable:onNodeChange", _onNodeChange);
		request.setAttribute("alloy:editable:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:editable:onRenderToChange", _onRenderToChange);
		request.setAttribute("alloy:editable:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:editable:onSave", _onSave);
		request.setAttribute("alloy:editable:onSaveButtonChange", _onSaveButtonChange);
		request.setAttribute("alloy:editable:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:editable:onStartEditing", _onStartEditing);
		request.setAttribute("alloy:editable:onStopEditing", _onStopEditing);
		request.setAttribute("alloy:editable:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:editable:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:editable:onUseARIAChange", _onUseARIAChange);
		request.setAttribute("alloy:editable:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:editable:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:editable:onRender", _onRender);
		request.setAttribute("alloy:editable:onWidthChange", _onWidthChange);
	}
