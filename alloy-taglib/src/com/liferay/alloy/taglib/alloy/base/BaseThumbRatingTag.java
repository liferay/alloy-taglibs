 ...
 * @generated
 */
public abstract class BaseThumbRatingTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:thumb-rating:boundingBox", _boundingBox);
		request.setAttribute("alloy:thumb-rating:canReset", String.valueOf(_canReset));
		request.setAttribute("alloy:thumb-rating:contentBox", _contentBox);
		request.setAttribute("alloy:thumb-rating:cssClass", _cssClass);
		request.setAttribute("alloy:thumb-rating:defaultSelected", _defaultSelected);
		request.setAttribute("alloy:thumb-rating:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:thumb-rating:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:thumb-rating:elements", _elements);
		request.setAttribute("alloy:thumb-rating:focused", String.valueOf(_focused));
		request.setAttribute("alloy:thumb-rating:height", _height);
		request.setAttribute("alloy:thumb-rating:hiddenInput", _hiddenInput);
		request.setAttribute("alloy:thumb-rating:hideClass", _hideClass);
		request.setAttribute("alloy:thumb-rating:id", _thumbratingId);
		request.setAttribute("alloy:thumb-rating:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:thumb-rating:inputName", _inputName);
		request.setAttribute("alloy:thumb-rating:label", _label);
		request.setAttribute("alloy:thumb-rating:labelNode", _labelNode);
		request.setAttribute("alloy:thumb-rating:render", _render);
		request.setAttribute("alloy:thumb-rating:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:thumb-rating:selectedIndex", _selectedIndex);
		request.setAttribute("alloy:thumb-rating:showTitle", String.valueOf(_showTitle));
		request.setAttribute("alloy:thumb-rating:size", _size);
		request.setAttribute("alloy:thumb-rating:srcNode", _srcNode);
		request.setAttribute("alloy:thumb-rating:strings", _strings);
		request.setAttribute("alloy:thumb-rating:tabIndex", _tabIndex);
		request.setAttribute("alloy:thumb-rating:title", _title);
		request.setAttribute("alloy:thumb-rating:useARIA", String.valueOf(_useARIA));
		request.setAttribute("alloy:thumb-rating:value", _thumbratingValue);
		request.setAttribute("alloy:thumb-rating:visible", String.valueOf(_visible));
		request.setAttribute("alloy:thumb-rating:width", _width);
		request.setAttribute("alloy:thumb-rating:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:thumb-rating:afterCanResetChange", _afterCanResetChange);
		request.setAttribute("alloy:thumb-rating:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:thumb-rating:afterCssClassChange", _afterCssClassChange);
		request.setAttribute("alloy:thumb-rating:afterDefaultSelectedChange", _afterDefaultSelectedChange);
		request.setAttribute("alloy:thumb-rating:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:thumb-rating:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:thumb-rating:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:thumb-rating:afterElementsChange", _afterElementsChange);
		request.setAttribute("alloy:thumb-rating:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:thumb-rating:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:thumb-rating:afterHiddenInputChange", _afterHiddenInputChange);
		request.setAttribute("alloy:thumb-rating:afterHideClassChange", _afterHideClassChange);
		request.setAttribute("alloy:thumb-rating:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:thumb-rating:afterInit", _afterInit);
		request.setAttribute("alloy:thumb-rating:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:thumb-rating:afterInputNameChange", _afterInputNameChange);
		request.setAttribute("alloy:thumb-rating:afterItemClick", _afterItemClick);
		request.setAttribute("alloy:thumb-rating:afterItemOut", _afterItemOut);
		request.setAttribute("alloy:thumb-rating:afterItemSelect", _afterItemSelect);
		request.setAttribute("alloy:thumb-rating:afterLabelChange", _afterLabelChange);
		request.setAttribute("alloy:thumb-rating:afterLabelNodeChange", _afterLabelNodeChange);
		request.setAttribute("alloy:thumb-rating:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:thumb-rating:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:thumb-rating:afterSelectedIndexChange", _afterSelectedIndexChange);
		request.setAttribute("alloy:thumb-rating:afterShowTitleChange", _afterShowTitleChange);
		request.setAttribute("alloy:thumb-rating:afterSizeChange", _afterSizeChange);
		request.setAttribute("alloy:thumb-rating:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:thumb-rating:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:thumb-rating:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:thumb-rating:afterTitleChange", _afterTitleChange);
		request.setAttribute("alloy:thumb-rating:afterUseARIAChange", _afterUseARIAChange);
		request.setAttribute("alloy:thumb-rating:afterValueChange", _afterValueChange);
		request.setAttribute("alloy:thumb-rating:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:thumb-rating:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:thumb-rating:afterRender", _afterRender);
		request.setAttribute("alloy:thumb-rating:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:thumb-rating:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:thumb-rating:onCanResetChange", _onCanResetChange);
		request.setAttribute("alloy:thumb-rating:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:thumb-rating:onCssClassChange", _onCssClassChange);
		request.setAttribute("alloy:thumb-rating:onDefaultSelectedChange", _onDefaultSelectedChange);
		request.setAttribute("alloy:thumb-rating:onDestroy", _onDestroy);
		request.setAttribute("alloy:thumb-rating:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:thumb-rating:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:thumb-rating:onElementsChange", _onElementsChange);
		request.setAttribute("alloy:thumb-rating:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:thumb-rating:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:thumb-rating:onHiddenInputChange", _onHiddenInputChange);
		request.setAttribute("alloy:thumb-rating:onHideClassChange", _onHideClassChange);
		request.setAttribute("alloy:thumb-rating:onIdChange", _onIdChange);
		request.setAttribute("alloy:thumb-rating:onInit", _onInit);
		request.setAttribute("alloy:thumb-rating:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:thumb-rating:onInputNameChange", _onInputNameChange);
		request.setAttribute("alloy:thumb-rating:onItemClick", _onItemClick);
		request.setAttribute("alloy:thumb-rating:onItemOut", _onItemOut);
		request.setAttribute("alloy:thumb-rating:onItemSelect", _onItemSelect);
		request.setAttribute("alloy:thumb-rating:onLabelChange", _onLabelChange);
		request.setAttribute("alloy:thumb-rating:onLabelNodeChange", _onLabelNodeChange);
		request.setAttribute("alloy:thumb-rating:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:thumb-rating:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:thumb-rating:onSelectedIndexChange", _onSelectedIndexChange);
		request.setAttribute("alloy:thumb-rating:onShowTitleChange", _onShowTitleChange);
		request.setAttribute("alloy:thumb-rating:onSizeChange", _onSizeChange);
		request.setAttribute("alloy:thumb-rating:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:thumb-rating:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:thumb-rating:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:thumb-rating:onTitleChange", _onTitleChange);
		request.setAttribute("alloy:thumb-rating:onUseARIAChange", _onUseARIAChange);
		request.setAttribute("alloy:thumb-rating:onValueChange", _onValueChange);
		request.setAttribute("alloy:thumb-rating:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:thumb-rating:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:thumb-rating:onRender", _onRender);
		request.setAttribute("alloy:thumb-rating:onWidthChange", _onWidthChange);
	}
