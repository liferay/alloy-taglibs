 ...
 * @generated
 */
public abstract class BaseToolbarTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:toolbar:activeDescendant", _activeDescendant);
		request.setAttribute("alloy:toolbar:activeState", String.valueOf(_activeState));
		request.setAttribute("alloy:toolbar:boundingBox", _boundingBox);
		request.setAttribute("alloy:toolbar:children", _children);
		request.setAttribute("alloy:toolbar:contentBox", _contentBox);
		request.setAttribute("alloy:toolbar:cssClass", _cssClass);
		request.setAttribute("alloy:toolbar:defaultChildType", _defaultChildType);
		request.setAttribute("alloy:toolbar:defaultState", String.valueOf(_defaultState));
		request.setAttribute("alloy:toolbar:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:toolbar:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:toolbar:focused", String.valueOf(_focused));
		request.setAttribute("alloy:toolbar:height", _height);
		request.setAttribute("alloy:toolbar:hideClass", _hideClass);
		request.setAttribute("alloy:toolbar:hoverState", String.valueOf(_hoverState));
		request.setAttribute("alloy:toolbar:id", _toolbarId);
		request.setAttribute("alloy:toolbar:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:toolbar:multiple", String.valueOf(_multiple));
		request.setAttribute("alloy:toolbar:orientation", _orientation);
		request.setAttribute("alloy:toolbar:render", _render);
		request.setAttribute("alloy:toolbar:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:toolbar:selection", _selection);
		request.setAttribute("alloy:toolbar:srcNode", _srcNode);
		request.setAttribute("alloy:toolbar:strings", _strings);
		request.setAttribute("alloy:toolbar:tabIndex", _tabIndex);
		request.setAttribute("alloy:toolbar:useARIA", String.valueOf(_useARIA));
		request.setAttribute("alloy:toolbar:visible", String.valueOf(_visible));
		request.setAttribute("alloy:toolbar:width", _width);
		request.setAttribute("alloy:toolbar:afterActiveDescendantChange", _afterActiveDescendantChange);
		request.setAttribute("alloy:toolbar:afterActiveStateChange", _afterActiveStateChange);
		request.setAttribute("alloy:toolbar:afterAddChild", _afterAddChild);
		request.setAttribute("alloy:toolbar:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:toolbar:afterChildrenChange", _afterChildrenChange);
		request.setAttribute("alloy:toolbar:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:toolbar:afterCssClassChange", _afterCssClassChange);
		request.setAttribute("alloy:toolbar:afterDefaultChildTypeChange", _afterDefaultChildTypeChange);
		request.setAttribute("alloy:toolbar:afterDefaultStateChange", _afterDefaultStateChange);
		request.setAttribute("alloy:toolbar:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:toolbar:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:toolbar:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:toolbar:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:toolbar:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:toolbar:afterHideClassChange", _afterHideClassChange);
		request.setAttribute("alloy:toolbar:afterHoverStateChange", _afterHoverStateChange);
		request.setAttribute("alloy:toolbar:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:toolbar:afterInit", _afterInit);
		request.setAttribute("alloy:toolbar:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:toolbar:afterMultipleChange", _afterMultipleChange);
		request.setAttribute("alloy:toolbar:afterOrientationChange", _afterOrientationChange);
		request.setAttribute("alloy:toolbar:afterRemoveChild", _afterRemoveChild);
		request.setAttribute("alloy:toolbar:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:toolbar:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:toolbar:afterSelectionChange", _afterSelectionChange);
		request.setAttribute("alloy:toolbar:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:toolbar:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:toolbar:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:toolbar:afterUseARIAChange", _afterUseARIAChange);
		request.setAttribute("alloy:toolbar:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:toolbar:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:toolbar:afterRender", _afterRender);
		request.setAttribute("alloy:toolbar:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:toolbar:onActiveDescendantChange", _onActiveDescendantChange);
		request.setAttribute("alloy:toolbar:onActiveStateChange", _onActiveStateChange);
		request.setAttribute("alloy:toolbar:onAddChild", _onAddChild);
		request.setAttribute("alloy:toolbar:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:toolbar:onChildrenChange", _onChildrenChange);
		request.setAttribute("alloy:toolbar:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:toolbar:onCssClassChange", _onCssClassChange);
		request.setAttribute("alloy:toolbar:onDefaultChildTypeChange", _onDefaultChildTypeChange);
		request.setAttribute("alloy:toolbar:onDefaultStateChange", _onDefaultStateChange);
		request.setAttribute("alloy:toolbar:onDestroy", _onDestroy);
		request.setAttribute("alloy:toolbar:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:toolbar:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:toolbar:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:toolbar:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:toolbar:onHideClassChange", _onHideClassChange);
		request.setAttribute("alloy:toolbar:onHoverStateChange", _onHoverStateChange);
		request.setAttribute("alloy:toolbar:onIdChange", _onIdChange);
		request.setAttribute("alloy:toolbar:onInit", _onInit);
		request.setAttribute("alloy:toolbar:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:toolbar:onMultipleChange", _onMultipleChange);
		request.setAttribute("alloy:toolbar:onOrientationChange", _onOrientationChange);
		request.setAttribute("alloy:toolbar:onRemoveChild", _onRemoveChild);
		request.setAttribute("alloy:toolbar:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:toolbar:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:toolbar:onSelectionChange", _onSelectionChange);
		request.setAttribute("alloy:toolbar:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:toolbar:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:toolbar:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:toolbar:onUseARIAChange", _onUseARIAChange);
		request.setAttribute("alloy:toolbar:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:toolbar:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:toolbar:onRender", _onRender);
		request.setAttribute("alloy:toolbar:onWidthChange", _onWidthChange);
	}
