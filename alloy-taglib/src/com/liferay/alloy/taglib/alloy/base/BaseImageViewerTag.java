 ...
 * @generated
 */
public abstract class BaseImageViewerTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:image-viewer:align", _align);
		request.setAttribute("alloy:image-viewer:alignOn", _alignOn);
		request.setAttribute("alloy:image-viewer:anim", String.valueOf(_anim));
		request.setAttribute("alloy:image-viewer:arrowLeftEl", _arrowLeftEl);
		request.setAttribute("alloy:image-viewer:arrowRightEl", _arrowRightEl);
		request.setAttribute("alloy:image-viewer:bodyContent", _imageviewerBodyContent);
		request.setAttribute("alloy:image-viewer:boundingBox", _boundingBox);
		request.setAttribute("alloy:image-viewer:caption", _caption);
		request.setAttribute("alloy:image-viewer:captionEl", _captionEl);
		request.setAttribute("alloy:image-viewer:captionFromTitle", String.valueOf(_captionFromTitle));
		request.setAttribute("alloy:image-viewer:centered", String.valueOf(_centered));
		request.setAttribute("alloy:image-viewer:closeEl", _closeEl);
		request.setAttribute("alloy:image-viewer:constrain", _constrain);
		request.setAttribute("alloy:image-viewer:contentBox", _contentBox);
		request.setAttribute("alloy:image-viewer:cssClass", _cssClass);
		request.setAttribute("alloy:image-viewer:currentIndex", _currentIndex);
		request.setAttribute("alloy:image-viewer:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:image-viewer:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:image-viewer:fillHeight", _fillHeight);
		request.setAttribute("alloy:image-viewer:focused", String.valueOf(_focused));
		request.setAttribute("alloy:image-viewer:footerContent", _footerContent);
		request.setAttribute("alloy:image-viewer:headerContent", _headerContent);
		request.setAttribute("alloy:image-viewer:height", _height);
		request.setAttribute("alloy:image-viewer:hideClass", _hideClass);
		request.setAttribute("alloy:image-viewer:id", _imageviewerId);
		request.setAttribute("alloy:image-viewer:image", _image);
		request.setAttribute("alloy:image-viewer:imageAnim", _imageAnim);
		request.setAttribute("alloy:image-viewer:infoEl", _infoEl);
		request.setAttribute("alloy:image-viewer:infoTemplate", _infoTemplate);
		request.setAttribute("alloy:image-viewer:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:image-viewer:links", _links);
		request.setAttribute("alloy:image-viewer:loader", _loader);
		request.setAttribute("alloy:image-viewer:loading", String.valueOf(_loading));
		request.setAttribute("alloy:image-viewer:loadingEl", _loadingEl);
		request.setAttribute("alloy:image-viewer:maxHeight", _maxHeight);
		request.setAttribute("alloy:image-viewer:maxWidth", _maxWidth);
		request.setAttribute("alloy:image-viewer:modal", _modal);
		request.setAttribute("alloy:image-viewer:preloadAllImages", String.valueOf(_preloadAllImages));
		request.setAttribute("alloy:image-viewer:preventOverlap", String.valueOf(_preventOverlap));
		request.setAttribute("alloy:image-viewer:render", _render);
		request.setAttribute("alloy:image-viewer:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:image-viewer:shim", String.valueOf(_shim));
		request.setAttribute("alloy:image-viewer:showArrows", String.valueOf(_showArrows));
		request.setAttribute("alloy:image-viewer:showClose", String.valueOf(_showClose));
		request.setAttribute("alloy:image-viewer:srcNode", _srcNode);
		request.setAttribute("alloy:image-viewer:strings", _strings);
		request.setAttribute("alloy:image-viewer:tabIndex", _tabIndex);
		request.setAttribute("alloy:image-viewer:totalLinks", String.valueOf(_totalLinks));
		request.setAttribute("alloy:image-viewer:useARIA", String.valueOf(_useARIA));
		request.setAttribute("alloy:image-viewer:visible", String.valueOf(_visible));
		request.setAttribute("alloy:image-viewer:width", _width);
		request.setAttribute("alloy:image-viewer:x", _x);
		request.setAttribute("alloy:image-viewer:xy", _xy);
		request.setAttribute("alloy:image-viewer:y", _y);
		request.setAttribute("alloy:image-viewer:zIndex", _zIndex);
		request.setAttribute("alloy:image-viewer:afterAlignChange", _afterAlignChange);
		request.setAttribute("alloy:image-viewer:afterAlignOnChange", _afterAlignOnChange);
		request.setAttribute("alloy:image-viewer:afterAnim", _afterAnim);
		request.setAttribute("alloy:image-viewer:afterAnimChange", _afterAnimChange);
		request.setAttribute("alloy:image-viewer:afterArrowLeftElChange", _afterArrowLeftElChange);
		request.setAttribute("alloy:image-viewer:afterArrowRightElChange", _afterArrowRightElChange);
		request.setAttribute("alloy:image-viewer:afterBodyContentChange", _afterBodyContentChange);
		request.setAttribute("alloy:image-viewer:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:image-viewer:afterCaptionChange", _afterCaptionChange);
		request.setAttribute("alloy:image-viewer:afterCaptionElChange", _afterCaptionElChange);
		request.setAttribute("alloy:image-viewer:afterCaptionFromTitleChange", _afterCaptionFromTitleChange);
		request.setAttribute("alloy:image-viewer:afterCenteredChange", _afterCenteredChange);
		request.setAttribute("alloy:image-viewer:afterCloseElChange", _afterCloseElChange);
		request.setAttribute("alloy:image-viewer:afterConstrainChange", _afterConstrainChange);
		request.setAttribute("alloy:image-viewer:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:image-viewer:afterCssClassChange", _afterCssClassChange);
		request.setAttribute("alloy:image-viewer:afterCurrentIndexChange", _afterCurrentIndexChange);
		request.setAttribute("alloy:image-viewer:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:image-viewer:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:image-viewer:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:image-viewer:afterFillHeightChange", _afterFillHeightChange);
		request.setAttribute("alloy:image-viewer:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:image-viewer:afterFooterContentChange", _afterFooterContentChange);
		request.setAttribute("alloy:image-viewer:afterHeaderContentChange", _afterHeaderContentChange);
		request.setAttribute("alloy:image-viewer:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:image-viewer:afterHideClassChange", _afterHideClassChange);
		request.setAttribute("alloy:image-viewer:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:image-viewer:afterImageAnimChange", _afterImageAnimChange);
		request.setAttribute("alloy:image-viewer:afterImageChange", _afterImageChange);
		request.setAttribute("alloy:image-viewer:afterInfoElChange", _afterInfoElChange);
		request.setAttribute("alloy:image-viewer:afterInfoTemplateChange", _afterInfoTemplateChange);
		request.setAttribute("alloy:image-viewer:afterInit", _afterInit);
		request.setAttribute("alloy:image-viewer:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:image-viewer:afterLinksChange", _afterLinksChange);
		request.setAttribute("alloy:image-viewer:afterLoad", _afterLoad);
		request.setAttribute("alloy:image-viewer:afterLoaderChange", _afterLoaderChange);
		request.setAttribute("alloy:image-viewer:afterLoadingChange", _afterLoadingChange);
		request.setAttribute("alloy:image-viewer:afterLoadingElChange", _afterLoadingElChange);
		request.setAttribute("alloy:image-viewer:afterMaxHeightChange", _afterMaxHeightChange);
		request.setAttribute("alloy:image-viewer:afterMaxWidthChange", _afterMaxWidthChange);
		request.setAttribute("alloy:image-viewer:afterModalChange", _afterModalChange);
		request.setAttribute("alloy:image-viewer:afterPreloadAllImagesChange", _afterPreloadAllImagesChange);
		request.setAttribute("alloy:image-viewer:afterPreventOverlapChange", _afterPreventOverlapChange);
		request.setAttribute("alloy:image-viewer:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:image-viewer:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:image-viewer:afterRequest", _afterRequest);
		request.setAttribute("alloy:image-viewer:afterShimChange", _afterShimChange);
		request.setAttribute("alloy:image-viewer:afterShowArrowsChange", _afterShowArrowsChange);
		request.setAttribute("alloy:image-viewer:afterShowCloseChange", _afterShowCloseChange);
		request.setAttribute("alloy:image-viewer:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:image-viewer:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:image-viewer:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:image-viewer:afterTotalLinksChange", _afterTotalLinksChange);
		request.setAttribute("alloy:image-viewer:afterUseARIAChange", _afterUseARIAChange);
		request.setAttribute("alloy:image-viewer:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:image-viewer:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:image-viewer:afterRender", _afterRender);
		request.setAttribute("alloy:image-viewer:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:image-viewer:afterXChange", _afterXChange);
		request.setAttribute("alloy:image-viewer:afterXyChange", _afterXyChange);
		request.setAttribute("alloy:image-viewer:afterYChange", _afterYChange);
		request.setAttribute("alloy:image-viewer:afterZIndexChange", _afterZIndexChange);
		request.setAttribute("alloy:image-viewer:onAlignChange", _onAlignChange);
		request.setAttribute("alloy:image-viewer:onAlignOnChange", _onAlignOnChange);
		request.setAttribute("alloy:image-viewer:onAnim", _onAnim);
		request.setAttribute("alloy:image-viewer:onAnimChange", _onAnimChange);
		request.setAttribute("alloy:image-viewer:onArrowLeftElChange", _onArrowLeftElChange);
		request.setAttribute("alloy:image-viewer:onArrowRightElChange", _onArrowRightElChange);
		request.setAttribute("alloy:image-viewer:onBodyContentChange", _onBodyContentChange);
		request.setAttribute("alloy:image-viewer:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:image-viewer:onCaptionChange", _onCaptionChange);
		request.setAttribute("alloy:image-viewer:onCaptionElChange", _onCaptionElChange);
		request.setAttribute("alloy:image-viewer:onCaptionFromTitleChange", _onCaptionFromTitleChange);
		request.setAttribute("alloy:image-viewer:onCenteredChange", _onCenteredChange);
		request.setAttribute("alloy:image-viewer:onCloseElChange", _onCloseElChange);
		request.setAttribute("alloy:image-viewer:onConstrainChange", _onConstrainChange);
		request.setAttribute("alloy:image-viewer:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:image-viewer:onCssClassChange", _onCssClassChange);
		request.setAttribute("alloy:image-viewer:onCurrentIndexChange", _onCurrentIndexChange);
		request.setAttribute("alloy:image-viewer:onDestroy", _onDestroy);
		request.setAttribute("alloy:image-viewer:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:image-viewer:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:image-viewer:onFillHeightChange", _onFillHeightChange);
		request.setAttribute("alloy:image-viewer:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:image-viewer:onFooterContentChange", _onFooterContentChange);
		request.setAttribute("alloy:image-viewer:onHeaderContentChange", _onHeaderContentChange);
		request.setAttribute("alloy:image-viewer:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:image-viewer:onHideClassChange", _onHideClassChange);
		request.setAttribute("alloy:image-viewer:onIdChange", _onIdChange);
		request.setAttribute("alloy:image-viewer:onImageAnimChange", _onImageAnimChange);
		request.setAttribute("alloy:image-viewer:onImageChange", _onImageChange);
		request.setAttribute("alloy:image-viewer:onInfoElChange", _onInfoElChange);
		request.setAttribute("alloy:image-viewer:onInfoTemplateChange", _onInfoTemplateChange);
		request.setAttribute("alloy:image-viewer:onInit", _onInit);
		request.setAttribute("alloy:image-viewer:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:image-viewer:onLinksChange", _onLinksChange);
		request.setAttribute("alloy:image-viewer:onLoad", _onLoad);
		request.setAttribute("alloy:image-viewer:onLoaderChange", _onLoaderChange);
		request.setAttribute("alloy:image-viewer:onLoadingChange", _onLoadingChange);
		request.setAttribute("alloy:image-viewer:onLoadingElChange", _onLoadingElChange);
		request.setAttribute("alloy:image-viewer:onMaxHeightChange", _onMaxHeightChange);
		request.setAttribute("alloy:image-viewer:onMaxWidthChange", _onMaxWidthChange);
		request.setAttribute("alloy:image-viewer:onModalChange", _onModalChange);
		request.setAttribute("alloy:image-viewer:onPreloadAllImagesChange", _onPreloadAllImagesChange);
		request.setAttribute("alloy:image-viewer:onPreventOverlapChange", _onPreventOverlapChange);
		request.setAttribute("alloy:image-viewer:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:image-viewer:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:image-viewer:onRequest", _onRequest);
		request.setAttribute("alloy:image-viewer:onShimChange", _onShimChange);
		request.setAttribute("alloy:image-viewer:onShowArrowsChange", _onShowArrowsChange);
		request.setAttribute("alloy:image-viewer:onShowCloseChange", _onShowCloseChange);
		request.setAttribute("alloy:image-viewer:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:image-viewer:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:image-viewer:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:image-viewer:onTotalLinksChange", _onTotalLinksChange);
		request.setAttribute("alloy:image-viewer:onUseARIAChange", _onUseARIAChange);
		request.setAttribute("alloy:image-viewer:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:image-viewer:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:image-viewer:onRender", _onRender);
		request.setAttribute("alloy:image-viewer:onWidthChange", _onWidthChange);
		request.setAttribute("alloy:image-viewer:onXChange", _onXChange);
		request.setAttribute("alloy:image-viewer:onXyChange", _onXyChange);
		request.setAttribute("alloy:image-viewer:onYChange", _onYChange);
		request.setAttribute("alloy:image-viewer:onZIndexChange", _onZIndexChange);
	}
