 ...
 * @generated
 */
public abstract class BaseColorPickerTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:color-picker:align", _align);
		request.setAttribute("alloy:color-picker:alignOn", _alignOn);
		request.setAttribute("alloy:color-picker:bodyContent", _colorpickerBodyContent);
		request.setAttribute("alloy:color-picker:boundingBox", _boundingBox);
		request.setAttribute("alloy:color-picker:cancellableHide", String.valueOf(_cancellableHide));
		request.setAttribute("alloy:color-picker:centered", _centered);
		request.setAttribute("alloy:color-picker:constrain", _constrain);
		request.setAttribute("alloy:color-picker:contentBox", _contentBox);
		request.setAttribute("alloy:color-picker:cssClass", _cssClass);
		request.setAttribute("alloy:color-picker:currentNode", _currentNode);
		request.setAttribute("alloy:color-picker:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:color-picker:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:color-picker:fillHeight", _fillHeight);
		request.setAttribute("alloy:color-picker:focused", String.valueOf(_focused));
		request.setAttribute("alloy:color-picker:footerContent", _footerContent);
		request.setAttribute("alloy:color-picker:headerContent", _headerContent);
		request.setAttribute("alloy:color-picker:height", _height);
		request.setAttribute("alloy:color-picker:hideClass", _hideClass);
		request.setAttribute("alloy:color-picker:hideDelay", _hideDelay);
		request.setAttribute("alloy:color-picker:hideOn", _hideOn);
		request.setAttribute("alloy:color-picker:hideOnDocumentClick", String.valueOf(_hideOnDocumentClick));
		request.setAttribute("alloy:color-picker:id", _colorpickerId);
		request.setAttribute("alloy:color-picker:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:color-picker:preventOverlap", String.valueOf(_preventOverlap));
		request.setAttribute("alloy:color-picker:render", _render);
		request.setAttribute("alloy:color-picker:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:color-picker:shim", String.valueOf(_shim));
		request.setAttribute("alloy:color-picker:showDelay", _showDelay);
		request.setAttribute("alloy:color-picker:showOn", _showOn);
		request.setAttribute("alloy:color-picker:srcNode", _srcNode);
		request.setAttribute("alloy:color-picker:strings", _strings);
		request.setAttribute("alloy:color-picker:tabIndex", _tabIndex);
		request.setAttribute("alloy:color-picker:trigger", _trigger);
		request.setAttribute("alloy:color-picker:useARIA", String.valueOf(_useARIA));
		request.setAttribute("alloy:color-picker:visible", String.valueOf(_visible));
		request.setAttribute("alloy:color-picker:width", _width);
		request.setAttribute("alloy:color-picker:x", _x);
		request.setAttribute("alloy:color-picker:xy", _xy);
		request.setAttribute("alloy:color-picker:y", _y);
		request.setAttribute("alloy:color-picker:zIndex", _zIndex);
		request.setAttribute("alloy:color-picker:afterAlignChange", _afterAlignChange);
		request.setAttribute("alloy:color-picker:afterAlignOnChange", _afterAlignOnChange);
		request.setAttribute("alloy:color-picker:afterBodyContentChange", _afterBodyContentChange);
		request.setAttribute("alloy:color-picker:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:color-picker:afterCancellableHideChange", _afterCancellableHideChange);
		request.setAttribute("alloy:color-picker:afterCenteredChange", _afterCenteredChange);
		request.setAttribute("alloy:color-picker:afterConstrainChange", _afterConstrainChange);
		request.setAttribute("alloy:color-picker:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:color-picker:afterCssClassChange", _afterCssClassChange);
		request.setAttribute("alloy:color-picker:afterCurrentNodeChange", _afterCurrentNodeChange);
		request.setAttribute("alloy:color-picker:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:color-picker:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:color-picker:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:color-picker:afterFillHeightChange", _afterFillHeightChange);
		request.setAttribute("alloy:color-picker:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:color-picker:afterFooterContentChange", _afterFooterContentChange);
		request.setAttribute("alloy:color-picker:afterHeaderContentChange", _afterHeaderContentChange);
		request.setAttribute("alloy:color-picker:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:color-picker:afterHideClassChange", _afterHideClassChange);
		request.setAttribute("alloy:color-picker:afterHideDelayChange", _afterHideDelayChange);
		request.setAttribute("alloy:color-picker:afterHideOnChange", _afterHideOnChange);
		request.setAttribute("alloy:color-picker:afterHideOnDocumentClickChange", _afterHideOnDocumentClickChange);
		request.setAttribute("alloy:color-picker:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:color-picker:afterInit", _afterInit);
		request.setAttribute("alloy:color-picker:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:color-picker:afterPreventOverlapChange", _afterPreventOverlapChange);
		request.setAttribute("alloy:color-picker:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:color-picker:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:color-picker:afterShimChange", _afterShimChange);
		request.setAttribute("alloy:color-picker:afterShowDelayChange", _afterShowDelayChange);
		request.setAttribute("alloy:color-picker:afterShowOnChange", _afterShowOnChange);
		request.setAttribute("alloy:color-picker:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:color-picker:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:color-picker:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:color-picker:afterTriggerChange", _afterTriggerChange);
		request.setAttribute("alloy:color-picker:afterUseARIAChange", _afterUseARIAChange);
		request.setAttribute("alloy:color-picker:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:color-picker:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:color-picker:afterRender", _afterRender);
		request.setAttribute("alloy:color-picker:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:color-picker:afterXChange", _afterXChange);
		request.setAttribute("alloy:color-picker:afterXyChange", _afterXyChange);
		request.setAttribute("alloy:color-picker:afterYChange", _afterYChange);
		request.setAttribute("alloy:color-picker:afterZIndexChange", _afterZIndexChange);
		request.setAttribute("alloy:color-picker:onAlignChange", _onAlignChange);
		request.setAttribute("alloy:color-picker:onAlignOnChange", _onAlignOnChange);
		request.setAttribute("alloy:color-picker:onBodyContentChange", _onBodyContentChange);
		request.setAttribute("alloy:color-picker:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:color-picker:onCancellableHideChange", _onCancellableHideChange);
		request.setAttribute("alloy:color-picker:onCenteredChange", _onCenteredChange);
		request.setAttribute("alloy:color-picker:onConstrainChange", _onConstrainChange);
		request.setAttribute("alloy:color-picker:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:color-picker:onCssClassChange", _onCssClassChange);
		request.setAttribute("alloy:color-picker:onCurrentNodeChange", _onCurrentNodeChange);
		request.setAttribute("alloy:color-picker:onDestroy", _onDestroy);
		request.setAttribute("alloy:color-picker:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:color-picker:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:color-picker:onFillHeightChange", _onFillHeightChange);
		request.setAttribute("alloy:color-picker:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:color-picker:onFooterContentChange", _onFooterContentChange);
		request.setAttribute("alloy:color-picker:onHeaderContentChange", _onHeaderContentChange);
		request.setAttribute("alloy:color-picker:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:color-picker:onHideClassChange", _onHideClassChange);
		request.setAttribute("alloy:color-picker:onHideDelayChange", _onHideDelayChange);
		request.setAttribute("alloy:color-picker:onHideOnChange", _onHideOnChange);
		request.setAttribute("alloy:color-picker:onHideOnDocumentClickChange", _onHideOnDocumentClickChange);
		request.setAttribute("alloy:color-picker:onIdChange", _onIdChange);
		request.setAttribute("alloy:color-picker:onInit", _onInit);
		request.setAttribute("alloy:color-picker:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:color-picker:onPreventOverlapChange", _onPreventOverlapChange);
		request.setAttribute("alloy:color-picker:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:color-picker:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:color-picker:onShimChange", _onShimChange);
		request.setAttribute("alloy:color-picker:onShowDelayChange", _onShowDelayChange);
		request.setAttribute("alloy:color-picker:onShowOnChange", _onShowOnChange);
		request.setAttribute("alloy:color-picker:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:color-picker:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:color-picker:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:color-picker:onTriggerChange", _onTriggerChange);
		request.setAttribute("alloy:color-picker:onUseARIAChange", _onUseARIAChange);
		request.setAttribute("alloy:color-picker:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:color-picker:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:color-picker:onRender", _onRender);
		request.setAttribute("alloy:color-picker:onWidthChange", _onWidthChange);
		request.setAttribute("alloy:color-picker:onXChange", _onXChange);
		request.setAttribute("alloy:color-picker:onXyChange", _onXyChange);
		request.setAttribute("alloy:color-picker:onYChange", _onYChange);
		request.setAttribute("alloy:color-picker:onZIndexChange", _onZIndexChange);
	}
