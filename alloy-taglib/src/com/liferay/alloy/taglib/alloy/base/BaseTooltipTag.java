...
public abstract class BaseTooltipTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:tooltip:align", _align);
		request.setAttribute("alloy:tooltip:alignOn", _alignOn);
		request.setAttribute("alloy:tooltip:anim", _anim);
		request.setAttribute("alloy:tooltip:arrow", _arrow);
		request.setAttribute("alloy:tooltip:bodyContent", _tooltipBodyContent);
		request.setAttribute("alloy:tooltip:boundingBox", _boundingBox);
		request.setAttribute("alloy:tooltip:cancellableHide", String.valueOf(_cancellableHide));
		request.setAttribute("alloy:tooltip:centered", _centered);
		request.setAttribute("alloy:tooltip:constrain", _constrain);
		request.setAttribute("alloy:tooltip:contentBox", _contentBox);
		request.setAttribute("alloy:tooltip:cssClass", _cssClass);
		request.setAttribute("alloy:tooltip:currentNode", _currentNode);
		request.setAttribute("alloy:tooltip:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:tooltip:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:tooltip:fillHeight", _fillHeight);
		request.setAttribute("alloy:tooltip:focused", String.valueOf(_focused));
		request.setAttribute("alloy:tooltip:footerContent", _footerContent);
		request.setAttribute("alloy:tooltip:headerContent", _headerContent);
		request.setAttribute("alloy:tooltip:height", _height);
		request.setAttribute("alloy:tooltip:hideClass", _hideClass);
		request.setAttribute("alloy:tooltip:hideDelay", _hideDelay);
		request.setAttribute("alloy:tooltip:hideOn", _hideOn);
		request.setAttribute("alloy:tooltip:hideOnDocumentClick", String.valueOf(_hideOnDocumentClick));
		request.setAttribute("alloy:tooltip:id", _tooltipId);
		request.setAttribute("alloy:tooltip:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:tooltip:preventOverlap", String.valueOf(_preventOverlap));
		request.setAttribute("alloy:tooltip:render", _render);
		request.setAttribute("alloy:tooltip:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:tooltip:shim", String.valueOf(_shim));
		request.setAttribute("alloy:tooltip:showArrow", String.valueOf(_showArrow));
		request.setAttribute("alloy:tooltip:showDelay", _showDelay);
		request.setAttribute("alloy:tooltip:showOn", _showOn);
		request.setAttribute("alloy:tooltip:srcNode", _srcNode);
		request.setAttribute("alloy:tooltip:stack", String.valueOf(_stack));
		request.setAttribute("alloy:tooltip:strings", _strings);
		request.setAttribute("alloy:tooltip:tabIndex", _tabIndex);
		request.setAttribute("alloy:tooltip:title", String.valueOf(_title));
		request.setAttribute("alloy:tooltip:trigger", _trigger);
		request.setAttribute("alloy:tooltip:useARIA", String.valueOf(_useARIA));
		request.setAttribute("alloy:tooltip:visible", String.valueOf(_visible));
		request.setAttribute("alloy:tooltip:width", _width);
		request.setAttribute("alloy:tooltip:x", _x);
		request.setAttribute("alloy:tooltip:xy", _xy);
		request.setAttribute("alloy:tooltip:y", _y);
		request.setAttribute("alloy:tooltip:zIndex", _zIndex);
		request.setAttribute("alloy:tooltip:afterAlignChange", _afterAlignChange);
		request.setAttribute("alloy:tooltip:afterAlignOnChange", _afterAlignOnChange);
		request.setAttribute("alloy:tooltip:afterAnimChange", _afterAnimChange);
		request.setAttribute("alloy:tooltip:afterArrowChange", _afterArrowChange);
		request.setAttribute("alloy:tooltip:afterBodyContentChange", _afterBodyContentChange);
		request.setAttribute("alloy:tooltip:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:tooltip:afterCancellableHideChange", _afterCancellableHideChange);
		request.setAttribute("alloy:tooltip:afterCenteredChange", _afterCenteredChange);
		request.setAttribute("alloy:tooltip:afterConstrainChange", _afterConstrainChange);
		request.setAttribute("alloy:tooltip:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:tooltip:afterCssClassChange", _afterCssClassChange);
		request.setAttribute("alloy:tooltip:afterCurrentNodeChange", _afterCurrentNodeChange);
		request.setAttribute("alloy:tooltip:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:tooltip:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:tooltip:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:tooltip:afterFillHeightChange", _afterFillHeightChange);
		request.setAttribute("alloy:tooltip:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:tooltip:afterFooterContentChange", _afterFooterContentChange);
		request.setAttribute("alloy:tooltip:afterHeaderContentChange", _afterHeaderContentChange);
		request.setAttribute("alloy:tooltip:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:tooltip:afterHideClassChange", _afterHideClassChange);
		request.setAttribute("alloy:tooltip:afterHideDelayChange", _afterHideDelayChange);
		request.setAttribute("alloy:tooltip:afterHideOnChange", _afterHideOnChange);
		request.setAttribute("alloy:tooltip:afterHideOnDocumentClickChange", _afterHideOnDocumentClickChange);
		request.setAttribute("alloy:tooltip:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:tooltip:afterInit", _afterInit);
		request.setAttribute("alloy:tooltip:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:tooltip:afterPreventOverlapChange", _afterPreventOverlapChange);
		request.setAttribute("alloy:tooltip:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:tooltip:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:tooltip:afterShimChange", _afterShimChange);
		request.setAttribute("alloy:tooltip:afterShowArrowChange", _afterShowArrowChange);
		request.setAttribute("alloy:tooltip:afterShowDelayChange", _afterShowDelayChange);
		request.setAttribute("alloy:tooltip:afterShowOnChange", _afterShowOnChange);
		request.setAttribute("alloy:tooltip:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:tooltip:afterStackChange", _afterStackChange);
		request.setAttribute("alloy:tooltip:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:tooltip:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:tooltip:afterTitleChange", _afterTitleChange);
		request.setAttribute("alloy:tooltip:afterTriggerChange", _afterTriggerChange);
		request.setAttribute("alloy:tooltip:afterUseARIAChange", _afterUseARIAChange);
		request.setAttribute("alloy:tooltip:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:tooltip:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:tooltip:afterRender", _afterRender);
		request.setAttribute("alloy:tooltip:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:tooltip:afterXChange", _afterXChange);
		request.setAttribute("alloy:tooltip:afterXyChange", _afterXyChange);
		request.setAttribute("alloy:tooltip:afterYChange", _afterYChange);
		request.setAttribute("alloy:tooltip:afterZIndexChange", _afterZIndexChange);
		request.setAttribute("alloy:tooltip:onAlignChange", _onAlignChange);
		request.setAttribute("alloy:tooltip:onAlignOnChange", _onAlignOnChange);
		request.setAttribute("alloy:tooltip:onAnimChange", _onAnimChange);
		request.setAttribute("alloy:tooltip:onArrowChange", _onArrowChange);
		request.setAttribute("alloy:tooltip:onBodyContentChange", _onBodyContentChange);
		request.setAttribute("alloy:tooltip:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:tooltip:onCancellableHideChange", _onCancellableHideChange);
		request.setAttribute("alloy:tooltip:onCenteredChange", _onCenteredChange);
		request.setAttribute("alloy:tooltip:onConstrainChange", _onConstrainChange);
		request.setAttribute("alloy:tooltip:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:tooltip:onCssClassChange", _onCssClassChange);
		request.setAttribute("alloy:tooltip:onCurrentNodeChange", _onCurrentNodeChange);
		request.setAttribute("alloy:tooltip:onDestroy", _onDestroy);
		request.setAttribute("alloy:tooltip:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:tooltip:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:tooltip:onFillHeightChange", _onFillHeightChange);
		request.setAttribute("alloy:tooltip:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:tooltip:onFooterContentChange", _onFooterContentChange);
		request.setAttribute("alloy:tooltip:onHeaderContentChange", _onHeaderContentChange);
		request.setAttribute("alloy:tooltip:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:tooltip:onHideClassChange", _onHideClassChange);
		request.setAttribute("alloy:tooltip:onHideDelayChange", _onHideDelayChange);
		request.setAttribute("alloy:tooltip:onHideOnChange", _onHideOnChange);
		request.setAttribute("alloy:tooltip:onHideOnDocumentClickChange", _onHideOnDocumentClickChange);
		request.setAttribute("alloy:tooltip:onIdChange", _onIdChange);
		request.setAttribute("alloy:tooltip:onInit", _onInit);
		request.setAttribute("alloy:tooltip:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:tooltip:onPreventOverlapChange", _onPreventOverlapChange);
		request.setAttribute("alloy:tooltip:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:tooltip:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:tooltip:onShimChange", _onShimChange);
		request.setAttribute("alloy:tooltip:onShowArrowChange", _onShowArrowChange);
		request.setAttribute("alloy:tooltip:onShowDelayChange", _onShowDelayChange);
		request.setAttribute("alloy:tooltip:onShowOnChange", _onShowOnChange);
		request.setAttribute("alloy:tooltip:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:tooltip:onStackChange", _onStackChange);
		request.setAttribute("alloy:tooltip:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:tooltip:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:tooltip:onTitleChange", _onTitleChange);
		request.setAttribute("alloy:tooltip:onTriggerChange", _onTriggerChange);
		request.setAttribute("alloy:tooltip:onUseARIAChange", _onUseARIAChange);
		request.setAttribute("alloy:tooltip:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:tooltip:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:tooltip:onRender", _onRender);
		request.setAttribute("alloy:tooltip:onWidthChange", _onWidthChange);
		request.setAttribute("alloy:tooltip:onXChange", _onXChange);
		request.setAttribute("alloy:tooltip:onXyChange", _onXyChange);
		request.setAttribute("alloy:tooltip:onYChange", _onYChange);
		request.setAttribute("alloy:tooltip:onZIndexChange", _onZIndexChange);
	}
