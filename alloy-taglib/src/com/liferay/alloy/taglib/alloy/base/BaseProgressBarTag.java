...
public abstract class BaseProgressBarTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:progress-bar:boundingBox", _boundingBox);
		request.setAttribute("alloy:progress-bar:contentBox", _contentBox);
		request.setAttribute("alloy:progress-bar:cssClass", _cssClass);
		request.setAttribute("alloy:progress-bar:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:progress-bar:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:progress-bar:focused", String.valueOf(_focused));
		request.setAttribute("alloy:progress-bar:height", String.valueOf(_height));
		request.setAttribute("alloy:progress-bar:hideClass", _hideClass);
		request.setAttribute("alloy:progress-bar:id", _progressbarId);
		request.setAttribute("alloy:progress-bar:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:progress-bar:label", _label);
		request.setAttribute("alloy:progress-bar:max", String.valueOf(_max));
		request.setAttribute("alloy:progress-bar:min", String.valueOf(_min));
		request.setAttribute("alloy:progress-bar:orientation", _orientation);
		request.setAttribute("alloy:progress-bar:ratio", _ratio);
		request.setAttribute("alloy:progress-bar:render", _render);
		request.setAttribute("alloy:progress-bar:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:progress-bar:srcNode", _srcNode);
		request.setAttribute("alloy:progress-bar:statusNode", _statusNode);
		request.setAttribute("alloy:progress-bar:step", _step);
		request.setAttribute("alloy:progress-bar:strings", _strings);
		request.setAttribute("alloy:progress-bar:tabIndex", _tabIndex);
		request.setAttribute("alloy:progress-bar:textNode", _textNode);
		request.setAttribute("alloy:progress-bar:useARIA", String.valueOf(_useARIA));
		request.setAttribute("alloy:progress-bar:value", String.valueOf(_progressbarValue));
		request.setAttribute("alloy:progress-bar:visible", String.valueOf(_visible));
		request.setAttribute("alloy:progress-bar:width", _width);
		request.setAttribute("alloy:progress-bar:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:progress-bar:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:progress-bar:afterCssClassChange", _afterCssClassChange);
		request.setAttribute("alloy:progress-bar:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:progress-bar:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:progress-bar:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:progress-bar:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:progress-bar:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:progress-bar:afterHideClassChange", _afterHideClassChange);
		request.setAttribute("alloy:progress-bar:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:progress-bar:afterInit", _afterInit);
		request.setAttribute("alloy:progress-bar:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:progress-bar:afterLabelChange", _afterLabelChange);
		request.setAttribute("alloy:progress-bar:afterMaxChange", _afterMaxChange);
		request.setAttribute("alloy:progress-bar:afterMinChange", _afterMinChange);
		request.setAttribute("alloy:progress-bar:afterOrientationChange", _afterOrientationChange);
		request.setAttribute("alloy:progress-bar:afterRatioChange", _afterRatioChange);
		request.setAttribute("alloy:progress-bar:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:progress-bar:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:progress-bar:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:progress-bar:afterStatusNodeChange", _afterStatusNodeChange);
		request.setAttribute("alloy:progress-bar:afterStepChange", _afterStepChange);
		request.setAttribute("alloy:progress-bar:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:progress-bar:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:progress-bar:afterTextNodeChange", _afterTextNodeChange);
		request.setAttribute("alloy:progress-bar:afterUseARIAChange", _afterUseARIAChange);
		request.setAttribute("alloy:progress-bar:afterValueChange", _afterValueChange);
		request.setAttribute("alloy:progress-bar:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:progress-bar:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:progress-bar:afterRender", _afterRender);
		request.setAttribute("alloy:progress-bar:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:progress-bar:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:progress-bar:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:progress-bar:onCssClassChange", _onCssClassChange);
		request.setAttribute("alloy:progress-bar:onDestroy", _onDestroy);
		request.setAttribute("alloy:progress-bar:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:progress-bar:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:progress-bar:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:progress-bar:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:progress-bar:onHideClassChange", _onHideClassChange);
		request.setAttribute("alloy:progress-bar:onIdChange", _onIdChange);
		request.setAttribute("alloy:progress-bar:onInit", _onInit);
		request.setAttribute("alloy:progress-bar:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:progress-bar:onLabelChange", _onLabelChange);
		request.setAttribute("alloy:progress-bar:onMaxChange", _onMaxChange);
		request.setAttribute("alloy:progress-bar:onMinChange", _onMinChange);
		request.setAttribute("alloy:progress-bar:onOrientationChange", _onOrientationChange);
		request.setAttribute("alloy:progress-bar:onRatioChange", _onRatioChange);
		request.setAttribute("alloy:progress-bar:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:progress-bar:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:progress-bar:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:progress-bar:onStatusNodeChange", _onStatusNodeChange);
		request.setAttribute("alloy:progress-bar:onStepChange", _onStepChange);
		request.setAttribute("alloy:progress-bar:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:progress-bar:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:progress-bar:onTextNodeChange", _onTextNodeChange);
		request.setAttribute("alloy:progress-bar:onUseARIAChange", _onUseARIAChange);
		request.setAttribute("alloy:progress-bar:onValueChange", _onValueChange);
		request.setAttribute("alloy:progress-bar:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:progress-bar:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:progress-bar:onRender", _onRender);
		request.setAttribute("alloy:progress-bar:onWidthChange", _onWidthChange);
	}
