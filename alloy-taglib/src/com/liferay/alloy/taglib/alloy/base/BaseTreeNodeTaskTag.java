 ...
 * @generated
 */
public abstract class BaseTreeNodeTaskTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:tree-node-task:alwaysShowHitArea", String.valueOf(_alwaysShowHitArea));
		request.setAttribute("alloy:tree-node-task:cache", String.valueOf(_cache));
		request.setAttribute("alloy:tree-node-task:checkContainerEl", _checkContainerEl);
		request.setAttribute("alloy:tree-node-task:checkEl", _checkEl);
		request.setAttribute("alloy:tree-node-task:checkName", _checkName);
		request.setAttribute("alloy:tree-node-task:checked", String.valueOf(_checked));
		request.setAttribute("alloy:tree-node-task:children", _children);
		request.setAttribute("alloy:tree-node-task:container", _container);
		request.setAttribute("alloy:tree-node-task:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:tree-node-task:draggable", String.valueOf(_draggable));
		request.setAttribute("alloy:tree-node-task:expanded", String.valueOf(_expanded));
		request.setAttribute("alloy:tree-node-task:hitAreaEl", _hitAreaEl);
		request.setAttribute("alloy:tree-node-task:iconEl", _iconEl);
		request.setAttribute("alloy:tree-node-task:id", _treenodetaskId);
		request.setAttribute("alloy:tree-node-task:index", _index);
		request.setAttribute("alloy:tree-node-task:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:tree-node-task:io", _io);
		request.setAttribute("alloy:tree-node-task:label", _label);
		request.setAttribute("alloy:tree-node-task:labelEl", _labelEl);
		request.setAttribute("alloy:tree-node-task:leaf", String.valueOf(_leaf));
		request.setAttribute("alloy:tree-node-task:loaded", String.valueOf(_loaded));
		request.setAttribute("alloy:tree-node-task:loading", String.valueOf(_loading));
		request.setAttribute("alloy:tree-node-task:nextSibling", _nextSibling);
		request.setAttribute("alloy:tree-node-task:ownerTree", _ownerTree);
		request.setAttribute("alloy:tree-node-task:parentNode", _parentNode);
		request.setAttribute("alloy:tree-node-task:prevSibling", _prevSibling);
		request.setAttribute("alloy:tree-node-task:afterAlwaysShowHitAreaChange", _afterAlwaysShowHitAreaChange);
		request.setAttribute("alloy:tree-node-task:afterCacheChange", _afterCacheChange);
		request.setAttribute("alloy:tree-node-task:afterCheckContainerElChange", _afterCheckContainerElChange);
		request.setAttribute("alloy:tree-node-task:afterCheckElChange", _afterCheckElChange);
		request.setAttribute("alloy:tree-node-task:afterCheckNameChange", _afterCheckNameChange);
		request.setAttribute("alloy:tree-node-task:afterCheckedChange", _afterCheckedChange);
		request.setAttribute("alloy:tree-node-task:afterChildrenChange", _afterChildrenChange);
		request.setAttribute("alloy:tree-node-task:afterContainerChange", _afterContainerChange);
		request.setAttribute("alloy:tree-node-task:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:tree-node-task:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:tree-node-task:afterDraggableChange", _afterDraggableChange);
		request.setAttribute("alloy:tree-node-task:afterExpandedChange", _afterExpandedChange);
		request.setAttribute("alloy:tree-node-task:afterHitAreaElChange", _afterHitAreaElChange);
		request.setAttribute("alloy:tree-node-task:afterIconElChange", _afterIconElChange);
		request.setAttribute("alloy:tree-node-task:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:tree-node-task:afterIndexChange", _afterIndexChange);
		request.setAttribute("alloy:tree-node-task:afterInit", _afterInit);
		request.setAttribute("alloy:tree-node-task:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:tree-node-task:afterIoChange", _afterIoChange);
		request.setAttribute("alloy:tree-node-task:afterLabelChange", _afterLabelChange);
		request.setAttribute("alloy:tree-node-task:afterLabelElChange", _afterLabelElChange);
		request.setAttribute("alloy:tree-node-task:afterLeafChange", _afterLeafChange);
		request.setAttribute("alloy:tree-node-task:afterLoadedChange", _afterLoadedChange);
		request.setAttribute("alloy:tree-node-task:afterLoadingChange", _afterLoadingChange);
		request.setAttribute("alloy:tree-node-task:afterNextSiblingChange", _afterNextSiblingChange);
		request.setAttribute("alloy:tree-node-task:afterOwnerTreeChange", _afterOwnerTreeChange);
		request.setAttribute("alloy:tree-node-task:afterParentNodeChange", _afterParentNodeChange);
		request.setAttribute("alloy:tree-node-task:afterPrevSiblingChange", _afterPrevSiblingChange);
		request.setAttribute("alloy:tree-node-task:onAlwaysShowHitAreaChange", _onAlwaysShowHitAreaChange);
		request.setAttribute("alloy:tree-node-task:onCacheChange", _onCacheChange);
		request.setAttribute("alloy:tree-node-task:onCheckContainerElChange", _onCheckContainerElChange);
		request.setAttribute("alloy:tree-node-task:onCheckElChange", _onCheckElChange);
		request.setAttribute("alloy:tree-node-task:onCheckNameChange", _onCheckNameChange);
		request.setAttribute("alloy:tree-node-task:onCheckedChange", _onCheckedChange);
		request.setAttribute("alloy:tree-node-task:onChildrenChange", _onChildrenChange);
		request.setAttribute("alloy:tree-node-task:onContainerChange", _onContainerChange);
		request.setAttribute("alloy:tree-node-task:onDestroy", _onDestroy);
		request.setAttribute("alloy:tree-node-task:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:tree-node-task:onDraggableChange", _onDraggableChange);
		request.setAttribute("alloy:tree-node-task:onExpandedChange", _onExpandedChange);
		request.setAttribute("alloy:tree-node-task:onHitAreaElChange", _onHitAreaElChange);
		request.setAttribute("alloy:tree-node-task:onIconElChange", _onIconElChange);
		request.setAttribute("alloy:tree-node-task:onIdChange", _onIdChange);
		request.setAttribute("alloy:tree-node-task:onIndexChange", _onIndexChange);
		request.setAttribute("alloy:tree-node-task:onInit", _onInit);
		request.setAttribute("alloy:tree-node-task:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:tree-node-task:onIoChange", _onIoChange);
		request.setAttribute("alloy:tree-node-task:onLabelChange", _onLabelChange);
		request.setAttribute("alloy:tree-node-task:onLabelElChange", _onLabelElChange);
		request.setAttribute("alloy:tree-node-task:onLeafChange", _onLeafChange);
		request.setAttribute("alloy:tree-node-task:onLoadedChange", _onLoadedChange);
		request.setAttribute("alloy:tree-node-task:onLoadingChange", _onLoadingChange);
		request.setAttribute("alloy:tree-node-task:onNextSiblingChange", _onNextSiblingChange);
		request.setAttribute("alloy:tree-node-task:onOwnerTreeChange", _onOwnerTreeChange);
		request.setAttribute("alloy:tree-node-task:onParentNodeChange", _onParentNodeChange);
		request.setAttribute("alloy:tree-node-task:onPrevSiblingChange", _onPrevSiblingChange);
	}
