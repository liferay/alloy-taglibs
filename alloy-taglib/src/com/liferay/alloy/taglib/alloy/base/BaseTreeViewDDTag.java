...
public abstract class BaseTreeViewDDTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:tree-view-dd:checkContainerEl", _checkContainerEl);
		request.setAttribute("alloy:tree-view-dd:checkEl", _checkEl);
		request.setAttribute("alloy:tree-view-dd:checkName", _checkName);
		request.setAttribute("alloy:tree-view-dd:checked", String.valueOf(_checked));
		request.setAttribute("alloy:tree-view-dd:children", _children);
		request.setAttribute("alloy:tree-view-dd:container", _container);
		request.setAttribute("alloy:tree-view-dd:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:tree-view-dd:dropAction", _dropAction);
		request.setAttribute("alloy:tree-view-dd:helper", _helper);
		request.setAttribute("alloy:tree-view-dd:index", _index);
		request.setAttribute("alloy:tree-view-dd:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:tree-view-dd:io", _io);
		request.setAttribute("alloy:tree-view-dd:lastSelected", _lastSelected);
		request.setAttribute("alloy:tree-view-dd:lastY", _lastY);
		request.setAttribute("alloy:tree-view-dd:nodeContent", _nodeContent);
		request.setAttribute("alloy:tree-view-dd:scrollDelay", _scrollDelay);
		request.setAttribute("alloy:tree-view-dd:type", _type);
		request.setAttribute("alloy:tree-view-dd:afterCheckContainerElChange", _afterCheckContainerElChange);
		request.setAttribute("alloy:tree-view-dd:afterCheckElChange", _afterCheckElChange);
		request.setAttribute("alloy:tree-view-dd:afterCheckNameChange", _afterCheckNameChange);
		request.setAttribute("alloy:tree-view-dd:afterCheckedChange", _afterCheckedChange);
		request.setAttribute("alloy:tree-view-dd:afterChildrenChange", _afterChildrenChange);
		request.setAttribute("alloy:tree-view-dd:afterContainerChange", _afterContainerChange);
		request.setAttribute("alloy:tree-view-dd:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:tree-view-dd:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:tree-view-dd:afterDropActionChange", _afterDropActionChange);
		request.setAttribute("alloy:tree-view-dd:afterHelperChange", _afterHelperChange);
		request.setAttribute("alloy:tree-view-dd:afterIndexChange", _afterIndexChange);
		request.setAttribute("alloy:tree-view-dd:afterInit", _afterInit);
		request.setAttribute("alloy:tree-view-dd:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:tree-view-dd:afterIoChange", _afterIoChange);
		request.setAttribute("alloy:tree-view-dd:afterLastSelectedChange", _afterLastSelectedChange);
		request.setAttribute("alloy:tree-view-dd:afterLastYChange", _afterLastYChange);
		request.setAttribute("alloy:tree-view-dd:afterNodeContentChange", _afterNodeContentChange);
		request.setAttribute("alloy:tree-view-dd:afterScrollDelayChange", _afterScrollDelayChange);
		request.setAttribute("alloy:tree-view-dd:afterTypeChange", _afterTypeChange);
		request.setAttribute("alloy:tree-view-dd:onCheckContainerElChange", _onCheckContainerElChange);
		request.setAttribute("alloy:tree-view-dd:onCheckElChange", _onCheckElChange);
		request.setAttribute("alloy:tree-view-dd:onCheckNameChange", _onCheckNameChange);
		request.setAttribute("alloy:tree-view-dd:onCheckedChange", _onCheckedChange);
		request.setAttribute("alloy:tree-view-dd:onChildrenChange", _onChildrenChange);
		request.setAttribute("alloy:tree-view-dd:onContainerChange", _onContainerChange);
		request.setAttribute("alloy:tree-view-dd:onDestroy", _onDestroy);
		request.setAttribute("alloy:tree-view-dd:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:tree-view-dd:onDropActionChange", _onDropActionChange);
		request.setAttribute("alloy:tree-view-dd:onHelperChange", _onHelperChange);
		request.setAttribute("alloy:tree-view-dd:onIndexChange", _onIndexChange);
		request.setAttribute("alloy:tree-view-dd:onInit", _onInit);
		request.setAttribute("alloy:tree-view-dd:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:tree-view-dd:onIoChange", _onIoChange);
		request.setAttribute("alloy:tree-view-dd:onLastSelectedChange", _onLastSelectedChange);
		request.setAttribute("alloy:tree-view-dd:onLastYChange", _onLastYChange);
		request.setAttribute("alloy:tree-view-dd:onNodeContentChange", _onNodeContentChange);
		request.setAttribute("alloy:tree-view-dd:onScrollDelayChange", _onScrollDelayChange);
		request.setAttribute("alloy:tree-view-dd:onTypeChange", _onTypeChange);
	}
