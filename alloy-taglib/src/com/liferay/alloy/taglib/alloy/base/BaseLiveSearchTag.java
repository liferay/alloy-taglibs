 ...
 * @generated
 */
public abstract class BaseLiveSearchTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:live-search:data", _data);
		request.setAttribute("alloy:live-search:delay", _delay);
		request.setAttribute("alloy:live-search:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:live-search:hide", _hide);
		request.setAttribute("alloy:live-search:index", _index);
		request.setAttribute("alloy:live-search:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:live-search:input", _input);
		request.setAttribute("alloy:live-search:matchRegex", _matchRegex);
		request.setAttribute("alloy:live-search:nodes", _nodes);
		request.setAttribute("alloy:live-search:searchValue", _searchValue);
		request.setAttribute("alloy:live-search:show", _show);
		request.setAttribute("alloy:live-search:afterDataChange", _afterDataChange);
		request.setAttribute("alloy:live-search:afterDelayChange", _afterDelayChange);
		request.setAttribute("alloy:live-search:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:live-search:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:live-search:afterHideChange", _afterHideChange);
		request.setAttribute("alloy:live-search:afterIndexChange", _afterIndexChange);
		request.setAttribute("alloy:live-search:afterInit", _afterInit);
		request.setAttribute("alloy:live-search:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:live-search:afterInputChange", _afterInputChange);
		request.setAttribute("alloy:live-search:afterMatchRegexChange", _afterMatchRegexChange);
		request.setAttribute("alloy:live-search:afterNodesChange", _afterNodesChange);
		request.setAttribute("alloy:live-search:afterSearchValueChange", _afterSearchValueChange);
		request.setAttribute("alloy:live-search:afterShowChange", _afterShowChange);
		request.setAttribute("alloy:live-search:onDataChange", _onDataChange);
		request.setAttribute("alloy:live-search:onDelayChange", _onDelayChange);
		request.setAttribute("alloy:live-search:onDestroy", _onDestroy);
		request.setAttribute("alloy:live-search:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:live-search:onHideChange", _onHideChange);
		request.setAttribute("alloy:live-search:onIndexChange", _onIndexChange);
		request.setAttribute("alloy:live-search:onInit", _onInit);
		request.setAttribute("alloy:live-search:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:live-search:onInputChange", _onInputChange);
		request.setAttribute("alloy:live-search:onMatchRegexChange", _onMatchRegexChange);
		request.setAttribute("alloy:live-search:onNodesChange", _onNodesChange);
		request.setAttribute("alloy:live-search:onSearchValueChange", _onSearchValueChange);
		request.setAttribute("alloy:live-search:onShowChange", _onShowChange);
	}
