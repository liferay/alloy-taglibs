 ...
 * @generated
 */
public abstract class BaseOverlayContextTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:overlay-context:align", _align);
		request.setAttribute("alloy:overlay-context:alignOn", _alignOn);
		request.setAttribute("alloy:overlay-context:bodyContent", _overlaycontextBodyContent);
		request.setAttribute("alloy:overlay-context:boundingBox", _boundingBox);
		request.setAttribute("alloy:overlay-context:cancellableHide", String.valueOf(_cancellableHide));
		request.setAttribute("alloy:overlay-context:centered", _centered);
		request.setAttribute("alloy:overlay-context:constrain", _constrain);
		request.setAttribute("alloy:overlay-context:contentBox", _contentBox);
		request.setAttribute("alloy:overlay-context:cssClass", _cssClass);
		request.setAttribute("alloy:overlay-context:currentNode", _currentNode);
		request.setAttribute("alloy:overlay-context:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:overlay-context:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:overlay-context:fillHeight", _fillHeight);
		request.setAttribute("alloy:overlay-context:focused", String.valueOf(_focused));
		request.setAttribute("alloy:overlay-context:footerContent", _footerContent);
		request.setAttribute("alloy:overlay-context:headerContent", _headerContent);
		request.setAttribute("alloy:overlay-context:height", _height);
		request.setAttribute("alloy:overlay-context:hideClass", _hideClass);
		request.setAttribute("alloy:overlay-context:hideDelay", _hideDelay);
		request.setAttribute("alloy:overlay-context:hideOn", _hideOn);
		request.setAttribute("alloy:overlay-context:hideOnDocumentClick", String.valueOf(_hideOnDocumentClick));
		request.setAttribute("alloy:overlay-context:id", _overlaycontextId);
		request.setAttribute("alloy:overlay-context:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:overlay-context:preventOverlap", String.valueOf(_preventOverlap));
		request.setAttribute("alloy:overlay-context:render", _render);
		request.setAttribute("alloy:overlay-context:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:overlay-context:shim", String.valueOf(_shim));
		request.setAttribute("alloy:overlay-context:showDelay", _showDelay);
		request.setAttribute("alloy:overlay-context:showOn", _showOn);
		request.setAttribute("alloy:overlay-context:srcNode", _srcNode);
		request.setAttribute("alloy:overlay-context:strings", _strings);
		request.setAttribute("alloy:overlay-context:tabIndex", _tabIndex);
		request.setAttribute("alloy:overlay-context:trigger", _trigger);
		request.setAttribute("alloy:overlay-context:useARIA", String.valueOf(_useARIA));
		request.setAttribute("alloy:overlay-context:visible", String.valueOf(_visible));
		request.setAttribute("alloy:overlay-context:width", _width);
		request.setAttribute("alloy:overlay-context:x", _x);
		request.setAttribute("alloy:overlay-context:xy", _xy);
		request.setAttribute("alloy:overlay-context:y", _y);
		request.setAttribute("alloy:overlay-context:zIndex", _zIndex);
		request.setAttribute("alloy:overlay-context:afterAlignChange", _afterAlignChange);
		request.setAttribute("alloy:overlay-context:afterAlignOnChange", _afterAlignOnChange);
		request.setAttribute("alloy:overlay-context:afterBodyContentChange", _afterBodyContentChange);
		request.setAttribute("alloy:overlay-context:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:overlay-context:afterCancellableHideChange", _afterCancellableHideChange);
		request.setAttribute("alloy:overlay-context:afterCenteredChange", _afterCenteredChange);
		request.setAttribute("alloy:overlay-context:afterConstrainChange", _afterConstrainChange);
		request.setAttribute("alloy:overlay-context:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:overlay-context:afterCssClassChange", _afterCssClassChange);
		request.setAttribute("alloy:overlay-context:afterCurrentNodeChange", _afterCurrentNodeChange);
		request.setAttribute("alloy:overlay-context:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:overlay-context:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:overlay-context:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:overlay-context:afterFillHeightChange", _afterFillHeightChange);
		request.setAttribute("alloy:overlay-context:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:overlay-context:afterFooterContentChange", _afterFooterContentChange);
		request.setAttribute("alloy:overlay-context:afterHeaderContentChange", _afterHeaderContentChange);
		request.setAttribute("alloy:overlay-context:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:overlay-context:afterHideClassChange", _afterHideClassChange);
		request.setAttribute("alloy:overlay-context:afterHideDelayChange", _afterHideDelayChange);
		request.setAttribute("alloy:overlay-context:afterHideOnChange", _afterHideOnChange);
		request.setAttribute("alloy:overlay-context:afterHideOnDocumentClickChange", _afterHideOnDocumentClickChange);
		request.setAttribute("alloy:overlay-context:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:overlay-context:afterInit", _afterInit);
		request.setAttribute("alloy:overlay-context:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:overlay-context:afterPreventOverlapChange", _afterPreventOverlapChange);
		request.setAttribute("alloy:overlay-context:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:overlay-context:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:overlay-context:afterShimChange", _afterShimChange);
		request.setAttribute("alloy:overlay-context:afterShowDelayChange", _afterShowDelayChange);
		request.setAttribute("alloy:overlay-context:afterShowOnChange", _afterShowOnChange);
		request.setAttribute("alloy:overlay-context:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:overlay-context:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:overlay-context:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:overlay-context:afterTriggerChange", _afterTriggerChange);
		request.setAttribute("alloy:overlay-context:afterUseARIAChange", _afterUseARIAChange);
		request.setAttribute("alloy:overlay-context:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:overlay-context:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:overlay-context:afterRender", _afterRender);
		request.setAttribute("alloy:overlay-context:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:overlay-context:afterXChange", _afterXChange);
		request.setAttribute("alloy:overlay-context:afterXyChange", _afterXyChange);
		request.setAttribute("alloy:overlay-context:afterYChange", _afterYChange);
		request.setAttribute("alloy:overlay-context:afterZIndexChange", _afterZIndexChange);
		request.setAttribute("alloy:overlay-context:onAlignChange", _onAlignChange);
		request.setAttribute("alloy:overlay-context:onAlignOnChange", _onAlignOnChange);
		request.setAttribute("alloy:overlay-context:onBodyContentChange", _onBodyContentChange);
		request.setAttribute("alloy:overlay-context:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:overlay-context:onCancellableHideChange", _onCancellableHideChange);
		request.setAttribute("alloy:overlay-context:onCenteredChange", _onCenteredChange);
		request.setAttribute("alloy:overlay-context:onConstrainChange", _onConstrainChange);
		request.setAttribute("alloy:overlay-context:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:overlay-context:onCssClassChange", _onCssClassChange);
		request.setAttribute("alloy:overlay-context:onCurrentNodeChange", _onCurrentNodeChange);
		request.setAttribute("alloy:overlay-context:onDestroy", _onDestroy);
		request.setAttribute("alloy:overlay-context:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:overlay-context:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:overlay-context:onFillHeightChange", _onFillHeightChange);
		request.setAttribute("alloy:overlay-context:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:overlay-context:onFooterContentChange", _onFooterContentChange);
		request.setAttribute("alloy:overlay-context:onHeaderContentChange", _onHeaderContentChange);
		request.setAttribute("alloy:overlay-context:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:overlay-context:onHideClassChange", _onHideClassChange);
		request.setAttribute("alloy:overlay-context:onHideDelayChange", _onHideDelayChange);
		request.setAttribute("alloy:overlay-context:onHideOnChange", _onHideOnChange);
		request.setAttribute("alloy:overlay-context:onHideOnDocumentClickChange", _onHideOnDocumentClickChange);
		request.setAttribute("alloy:overlay-context:onIdChange", _onIdChange);
		request.setAttribute("alloy:overlay-context:onInit", _onInit);
		request.setAttribute("alloy:overlay-context:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:overlay-context:onPreventOverlapChange", _onPreventOverlapChange);
		request.setAttribute("alloy:overlay-context:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:overlay-context:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:overlay-context:onShimChange", _onShimChange);
		request.setAttribute("alloy:overlay-context:onShowDelayChange", _onShowDelayChange);
		request.setAttribute("alloy:overlay-context:onShowOnChange", _onShowOnChange);
		request.setAttribute("alloy:overlay-context:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:overlay-context:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:overlay-context:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:overlay-context:onTriggerChange", _onTriggerChange);
		request.setAttribute("alloy:overlay-context:onUseARIAChange", _onUseARIAChange);
		request.setAttribute("alloy:overlay-context:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:overlay-context:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:overlay-context:onRender", _onRender);
		request.setAttribute("alloy:overlay-context:onWidthChange", _onWidthChange);
		request.setAttribute("alloy:overlay-context:onXChange", _onXChange);
		request.setAttribute("alloy:overlay-context:onXyChange", _onXyChange);
		request.setAttribute("alloy:overlay-context:onYChange", _onYChange);
		request.setAttribute("alloy:overlay-context:onZIndexChange", _onZIndexChange);
	}
