 ...
 * @generated
 */
public abstract class BaseCalendarTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:calendar:allowNone", String.valueOf(_allowNone));
		request.setAttribute("alloy:calendar:blankDays", _blankDays);
		request.setAttribute("alloy:calendar:boundingBox", _boundingBox);
		request.setAttribute("alloy:calendar:contentBox", _contentBox);
		request.setAttribute("alloy:calendar:currentDay", _currentDay);
		request.setAttribute("alloy:calendar:currentMonth", _currentMonth);
		request.setAttribute("alloy:calendar:currentYear", _currentYear);
		request.setAttribute("alloy:calendar:customRenderer", _customRenderer);
		request.setAttribute("alloy:calendar:date", _date);
		request.setAttribute("alloy:calendar:dateFormat", _dateFormat);
		request.setAttribute("alloy:calendar:dates", _dates);
		request.setAttribute("alloy:calendar:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:calendar:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:calendar:disabledDatesRule", _disabledDatesRule);
		request.setAttribute("alloy:calendar:enabledDatesRule", _enabledDatesRule);
		request.setAttribute("alloy:calendar:firstDayOfWeek", _firstDayOfWeek);
		request.setAttribute("alloy:calendar:focused", String.valueOf(_focused));
		request.setAttribute("alloy:calendar:headerContentNode", _headerContentNode);
		request.setAttribute("alloy:calendar:headerRenderer", _headerRenderer);
		request.setAttribute("alloy:calendar:headerTitleNode", _headerTitleNode);
		request.setAttribute("alloy:calendar:height", _height);
		request.setAttribute("alloy:calendar:iconNextNode", _iconNextNode);
		request.setAttribute("alloy:calendar:iconPrevNode", _iconPrevNode);
		request.setAttribute("alloy:calendar:id", _calendarId);
		request.setAttribute("alloy:calendar:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:calendar:maxDate", _maxDate);
		request.setAttribute("alloy:calendar:maximumDate", _maximumDate);
		request.setAttribute("alloy:calendar:minDate", _minDate);
		request.setAttribute("alloy:calendar:minimumDate", _minimumDate);
		request.setAttribute("alloy:calendar:monthDays", _monthDays);
		request.setAttribute("alloy:calendar:monthDaysNode", _monthDaysNode);
		request.setAttribute("alloy:calendar:noneLinkNode", _noneLinkNode);
		request.setAttribute("alloy:calendar:paddingDaysEnd", _paddingDaysEnd);
		request.setAttribute("alloy:calendar:paddingDaysStart", _paddingDaysStart);
		request.setAttribute("alloy:calendar:render", _render);
		request.setAttribute("alloy:calendar:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:calendar:selectMultipleDates", String.valueOf(_selectMultipleDates));
		request.setAttribute("alloy:calendar:selectedDates", _selectedDates);
		request.setAttribute("alloy:calendar:selectionMode", _selectionMode);
		request.setAttribute("alloy:calendar:setValue", String.valueOf(_setValue));
		request.setAttribute("alloy:calendar:showNextMonth", String.valueOf(_showNextMonth));
		request.setAttribute("alloy:calendar:showOtherMonth", String.valueOf(_showOtherMonth));
		request.setAttribute("alloy:calendar:showPrevMonth", String.valueOf(_showPrevMonth));
		request.setAttribute("alloy:calendar:showToday", String.valueOf(_showToday));
		request.setAttribute("alloy:calendar:srcNode", _srcNode);
		request.setAttribute("alloy:calendar:strings", _strings);
		request.setAttribute("alloy:calendar:tabIndex", _tabIndex);
		request.setAttribute("alloy:calendar:todayLinkNode", _todayLinkNode);
		request.setAttribute("alloy:calendar:visible", String.valueOf(_visible));
		request.setAttribute("alloy:calendar:weekDays", _weekDays);
		request.setAttribute("alloy:calendar:weekDaysNode", _weekDaysNode);
		request.setAttribute("alloy:calendar:width", _width);
		request.setAttribute("alloy:calendar:afterAllowNoneChange", _afterAllowNoneChange);
		request.setAttribute("alloy:calendar:afterBlankDaysChange", _afterBlankDaysChange);
		request.setAttribute("alloy:calendar:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:calendar:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:calendar:afterCurrentDayChange", _afterCurrentDayChange);
		request.setAttribute("alloy:calendar:afterCurrentMonthChange", _afterCurrentMonthChange);
		request.setAttribute("alloy:calendar:afterCurrentYearChange", _afterCurrentYearChange);
		request.setAttribute("alloy:calendar:afterCustomRendererChange", _afterCustomRendererChange);
		request.setAttribute("alloy:calendar:afterDateChange", _afterDateChange);
		request.setAttribute("alloy:calendar:afterDateFormatChange", _afterDateFormatChange);
		request.setAttribute("alloy:calendar:afterDatesChange", _afterDatesChange);
		request.setAttribute("alloy:calendar:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:calendar:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:calendar:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:calendar:afterDisabledDatesRuleChange", _afterDisabledDatesRuleChange);
		request.setAttribute("alloy:calendar:afterEnabledDatesRuleChange", _afterEnabledDatesRuleChange);
		request.setAttribute("alloy:calendar:afterFirstDayOfWeekChange", _afterFirstDayOfWeekChange);
		request.setAttribute("alloy:calendar:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:calendar:afterHeaderContentNodeChange", _afterHeaderContentNodeChange);
		request.setAttribute("alloy:calendar:afterHeaderRendererChange", _afterHeaderRendererChange);
		request.setAttribute("alloy:calendar:afterHeaderTitleNodeChange", _afterHeaderTitleNodeChange);
		request.setAttribute("alloy:calendar:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:calendar:afterIconNextNodeChange", _afterIconNextNodeChange);
		request.setAttribute("alloy:calendar:afterIconPrevNodeChange", _afterIconPrevNodeChange);
		request.setAttribute("alloy:calendar:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:calendar:afterInit", _afterInit);
		request.setAttribute("alloy:calendar:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:calendar:afterMaxDateChange", _afterMaxDateChange);
		request.setAttribute("alloy:calendar:afterMaximumDateChange", _afterMaximumDateChange);
		request.setAttribute("alloy:calendar:afterMinDateChange", _afterMinDateChange);
		request.setAttribute("alloy:calendar:afterMinimumDateChange", _afterMinimumDateChange);
		request.setAttribute("alloy:calendar:afterMonthDaysChange", _afterMonthDaysChange);
		request.setAttribute("alloy:calendar:afterMonthDaysNodeChange", _afterMonthDaysNodeChange);
		request.setAttribute("alloy:calendar:afterNoneLinkNodeChange", _afterNoneLinkNodeChange);
		request.setAttribute("alloy:calendar:afterPaddingDaysEndChange", _afterPaddingDaysEndChange);
		request.setAttribute("alloy:calendar:afterPaddingDaysStartChange", _afterPaddingDaysStartChange);
		request.setAttribute("alloy:calendar:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:calendar:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:calendar:afterSelectMultipleDatesChange", _afterSelectMultipleDatesChange);
		request.setAttribute("alloy:calendar:afterSelectedDatesChange", _afterSelectedDatesChange);
		request.setAttribute("alloy:calendar:afterSelectionModeChange", _afterSelectionModeChange);
		request.setAttribute("alloy:calendar:afterSetValueChange", _afterSetValueChange);
		request.setAttribute("alloy:calendar:afterShowNextMonthChange", _afterShowNextMonthChange);
		request.setAttribute("alloy:calendar:afterShowOtherMonthChange", _afterShowOtherMonthChange);
		request.setAttribute("alloy:calendar:afterShowPrevMonthChange", _afterShowPrevMonthChange);
		request.setAttribute("alloy:calendar:afterShowTodayChange", _afterShowTodayChange);
		request.setAttribute("alloy:calendar:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:calendar:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:calendar:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:calendar:afterTodayLinkNodeChange", _afterTodayLinkNodeChange);
		request.setAttribute("alloy:calendar:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:calendar:afterWeekDaysChange", _afterWeekDaysChange);
		request.setAttribute("alloy:calendar:afterWeekDaysNodeChange", _afterWeekDaysNodeChange);
		request.setAttribute("alloy:calendar:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:calendar:afterRender", _afterRender);
		request.setAttribute("alloy:calendar:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:calendar:onAllowNoneChange", _onAllowNoneChange);
		request.setAttribute("alloy:calendar:onBlankDaysChange", _onBlankDaysChange);
		request.setAttribute("alloy:calendar:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:calendar:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:calendar:onCurrentDayChange", _onCurrentDayChange);
		request.setAttribute("alloy:calendar:onCurrentMonthChange", _onCurrentMonthChange);
		request.setAttribute("alloy:calendar:onCurrentYearChange", _onCurrentYearChange);
		request.setAttribute("alloy:calendar:onCustomRendererChange", _onCustomRendererChange);
		request.setAttribute("alloy:calendar:onDateChange", _onDateChange);
		request.setAttribute("alloy:calendar:onDateFormatChange", _onDateFormatChange);
		request.setAttribute("alloy:calendar:onDatesChange", _onDatesChange);
		request.setAttribute("alloy:calendar:onDestroy", _onDestroy);
		request.setAttribute("alloy:calendar:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:calendar:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:calendar:onDisabledDatesRuleChange", _onDisabledDatesRuleChange);
		request.setAttribute("alloy:calendar:onEnabledDatesRuleChange", _onEnabledDatesRuleChange);
		request.setAttribute("alloy:calendar:onFirstDayOfWeekChange", _onFirstDayOfWeekChange);
		request.setAttribute("alloy:calendar:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:calendar:onHeaderContentNodeChange", _onHeaderContentNodeChange);
		request.setAttribute("alloy:calendar:onHeaderRendererChange", _onHeaderRendererChange);
		request.setAttribute("alloy:calendar:onHeaderTitleNodeChange", _onHeaderTitleNodeChange);
		request.setAttribute("alloy:calendar:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:calendar:onIconNextNodeChange", _onIconNextNodeChange);
		request.setAttribute("alloy:calendar:onIconPrevNodeChange", _onIconPrevNodeChange);
		request.setAttribute("alloy:calendar:onIdChange", _onIdChange);
		request.setAttribute("alloy:calendar:onInit", _onInit);
		request.setAttribute("alloy:calendar:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:calendar:onMaxDateChange", _onMaxDateChange);
		request.setAttribute("alloy:calendar:onMaximumDateChange", _onMaximumDateChange);
		request.setAttribute("alloy:calendar:onMinDateChange", _onMinDateChange);
		request.setAttribute("alloy:calendar:onMinimumDateChange", _onMinimumDateChange);
		request.setAttribute("alloy:calendar:onMonthDaysChange", _onMonthDaysChange);
		request.setAttribute("alloy:calendar:onMonthDaysNodeChange", _onMonthDaysNodeChange);
		request.setAttribute("alloy:calendar:onNoneLinkNodeChange", _onNoneLinkNodeChange);
		request.setAttribute("alloy:calendar:onPaddingDaysEndChange", _onPaddingDaysEndChange);
		request.setAttribute("alloy:calendar:onPaddingDaysStartChange", _onPaddingDaysStartChange);
		request.setAttribute("alloy:calendar:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:calendar:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:calendar:onSelectMultipleDatesChange", _onSelectMultipleDatesChange);
		request.setAttribute("alloy:calendar:onSelectedDatesChange", _onSelectedDatesChange);
		request.setAttribute("alloy:calendar:onSelectionModeChange", _onSelectionModeChange);
		request.setAttribute("alloy:calendar:onSetValueChange", _onSetValueChange);
		request.setAttribute("alloy:calendar:onShowNextMonthChange", _onShowNextMonthChange);
		request.setAttribute("alloy:calendar:onShowOtherMonthChange", _onShowOtherMonthChange);
		request.setAttribute("alloy:calendar:onShowPrevMonthChange", _onShowPrevMonthChange);
		request.setAttribute("alloy:calendar:onShowTodayChange", _onShowTodayChange);
		request.setAttribute("alloy:calendar:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:calendar:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:calendar:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:calendar:onTodayLinkNodeChange", _onTodayLinkNodeChange);
		request.setAttribute("alloy:calendar:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:calendar:onWeekDaysChange", _onWeekDaysChange);
		request.setAttribute("alloy:calendar:onWeekDaysNodeChange", _onWeekDaysNodeChange);
		request.setAttribute("alloy:calendar:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:calendar:onRender", _onRender);
		request.setAttribute("alloy:calendar:onWidthChange", _onWidthChange);
	}
