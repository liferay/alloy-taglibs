...
public abstract class BaseTextboxlistTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("alloy:textboxlist:alwaysShowContainer", String.valueOf(_alwaysShowContainer));
		request.setAttribute("alloy:textboxlist:applyLocalFilter", String.valueOf(_applyLocalFilter));
		request.setAttribute("alloy:textboxlist:autoHighlight", String.valueOf(_autoHighlight));
		request.setAttribute("alloy:textboxlist:boundingBox", _boundingBox);
		request.setAttribute("alloy:textboxlist:button", String.valueOf(_button));
		request.setAttribute("alloy:textboxlist:contentBox", _contentBox);
		request.setAttribute("alloy:textboxlist:cssClass", _cssClass);
		request.setAttribute("alloy:textboxlist:dataSource", _dataSource);
		request.setAttribute("alloy:textboxlist:dataSourceType", _dataSourceType);
		request.setAttribute("alloy:textboxlist:delimChar", _delimChar);
		request.setAttribute("alloy:textboxlist:destroyed", String.valueOf(_destroyed));
		request.setAttribute("alloy:textboxlist:disabled", String.valueOf(_disabled));
		request.setAttribute("alloy:textboxlist:focused", String.valueOf(_focused));
		request.setAttribute("alloy:textboxlist:forceSelection", String.valueOf(_forceSelection));
		request.setAttribute("alloy:textboxlist:height", _height);
		request.setAttribute("alloy:textboxlist:hideClass", _hideClass);
		request.setAttribute("alloy:textboxlist:id", _textboxlistId);
		request.setAttribute("alloy:textboxlist:initialized", String.valueOf(_initialized));
		request.setAttribute("alloy:textboxlist:input", _input);
		request.setAttribute("alloy:textboxlist:matchKey", _matchKey);
		request.setAttribute("alloy:textboxlist:maxResultsDisplayed", _maxResultsDisplayed);
		request.setAttribute("alloy:textboxlist:minQueryLength", _minQueryLength);
		request.setAttribute("alloy:textboxlist:queryDelay", _queryDelay);
		request.setAttribute("alloy:textboxlist:queryInterval", _queryInterval);
		request.setAttribute("alloy:textboxlist:queryMatchCase", String.valueOf(_queryMatchCase));
		request.setAttribute("alloy:textboxlist:queryMatchContains", String.valueOf(_queryMatchContains));
		request.setAttribute("alloy:textboxlist:queryQuestionMark", String.valueOf(_queryQuestionMark));
		request.setAttribute("alloy:textboxlist:render", _render);
		request.setAttribute("alloy:textboxlist:rendered", String.valueOf(_rendered));
		request.setAttribute("alloy:textboxlist:schema", _schema);
		request.setAttribute("alloy:textboxlist:schemaType", _schemaType);
		request.setAttribute("alloy:textboxlist:srcNode", _srcNode);
		request.setAttribute("alloy:textboxlist:strings", _strings);
		request.setAttribute("alloy:textboxlist:suppressInputUpdate", String.valueOf(_suppressInputUpdate));
		request.setAttribute("alloy:textboxlist:tabIndex", _tabIndex);
		request.setAttribute("alloy:textboxlist:typeAhead", String.valueOf(_typeAhead));
		request.setAttribute("alloy:textboxlist:typeAheadDelay", _typeAheadDelay);
		request.setAttribute("alloy:textboxlist:uniqueName", _uniqueName);
		request.setAttribute("alloy:textboxlist:useARIA", String.valueOf(_useARIA));
		request.setAttribute("alloy:textboxlist:visible", String.valueOf(_visible));
		request.setAttribute("alloy:textboxlist:width", _width);
		request.setAttribute("alloy:textboxlist:afterAlwaysShowContainerChange", _afterAlwaysShowContainerChange);
		request.setAttribute("alloy:textboxlist:afterApplyLocalFilterChange", _afterApplyLocalFilterChange);
		request.setAttribute("alloy:textboxlist:afterAutoHighlightChange", _afterAutoHighlightChange);
		request.setAttribute("alloy:textboxlist:afterBoundingBoxChange", _afterBoundingBoxChange);
		request.setAttribute("alloy:textboxlist:afterButtonChange", _afterButtonChange);
		request.setAttribute("alloy:textboxlist:afterContainerCollapse", _afterContainerCollapse);
		request.setAttribute("alloy:textboxlist:afterContainerExpand", _afterContainerExpand);
		request.setAttribute("alloy:textboxlist:afterContainerPopulate", _afterContainerPopulate);
		request.setAttribute("alloy:textboxlist:afterContentBoxChange", _afterContentBoxChange);
		request.setAttribute("alloy:textboxlist:afterCssClassChange", _afterCssClassChange);
		request.setAttribute("alloy:textboxlist:afterDataError", _afterDataError);
		request.setAttribute("alloy:textboxlist:afterDataRequest", _afterDataRequest);
		request.setAttribute("alloy:textboxlist:afterDataReturn", _afterDataReturn);
		request.setAttribute("alloy:textboxlist:afterDataSourceChange", _afterDataSourceChange);
		request.setAttribute("alloy:textboxlist:afterDataSourceTypeChange", _afterDataSourceTypeChange);
		request.setAttribute("alloy:textboxlist:afterDelimCharChange", _afterDelimCharChange);
		request.setAttribute("alloy:textboxlist:afterDestroy", _afterDestroy);
		request.setAttribute("alloy:textboxlist:afterDestroyedChange", _afterDestroyedChange);
		request.setAttribute("alloy:textboxlist:afterDisabledChange", _afterDisabledChange);
		request.setAttribute("alloy:textboxlist:afterFocusedChange", _afterFocusedChange);
		request.setAttribute("alloy:textboxlist:afterForceSelectionChange", _afterForceSelectionChange);
		request.setAttribute("alloy:textboxlist:afterHeightChange", _afterHeightChange);
		request.setAttribute("alloy:textboxlist:afterHideClassChange", _afterHideClassChange);
		request.setAttribute("alloy:textboxlist:afterIdChange", _afterIdChange);
		request.setAttribute("alloy:textboxlist:afterInit", _afterInit);
		request.setAttribute("alloy:textboxlist:afterInitializedChange", _afterInitializedChange);
		request.setAttribute("alloy:textboxlist:afterInputChange", _afterInputChange);
		request.setAttribute("alloy:textboxlist:afterItemArrowFrom", _afterItemArrowFrom);
		request.setAttribute("alloy:textboxlist:afterItemArrowTo", _afterItemArrowTo);
		request.setAttribute("alloy:textboxlist:afterItemMouseOut", _afterItemMouseOut);
		request.setAttribute("alloy:textboxlist:afterItemMouseOver", _afterItemMouseOver);
		request.setAttribute("alloy:textboxlist:afterItemSelect", _afterItemSelect);
		request.setAttribute("alloy:textboxlist:afterMatchKeyChange", _afterMatchKeyChange);
		request.setAttribute("alloy:textboxlist:afterMaxResultsDisplayedChange", _afterMaxResultsDisplayedChange);
		request.setAttribute("alloy:textboxlist:afterMinQueryLengthChange", _afterMinQueryLengthChange);
		request.setAttribute("alloy:textboxlist:afterQueryDelayChange", _afterQueryDelayChange);
		request.setAttribute("alloy:textboxlist:afterQueryIntervalChange", _afterQueryIntervalChange);
		request.setAttribute("alloy:textboxlist:afterQueryMatchCaseChange", _afterQueryMatchCaseChange);
		request.setAttribute("alloy:textboxlist:afterQueryMatchContainsChange", _afterQueryMatchContainsChange);
		request.setAttribute("alloy:textboxlist:afterQueryQuestionMarkChange", _afterQueryQuestionMarkChange);
		request.setAttribute("alloy:textboxlist:afterRenderChange", _afterRenderChange);
		request.setAttribute("alloy:textboxlist:afterRenderedChange", _afterRenderedChange);
		request.setAttribute("alloy:textboxlist:afterSchemaChange", _afterSchemaChange);
		request.setAttribute("alloy:textboxlist:afterSchemaTypeChange", _afterSchemaTypeChange);
		request.setAttribute("alloy:textboxlist:afterSelectionEnforce", _afterSelectionEnforce);
		request.setAttribute("alloy:textboxlist:afterSrcNodeChange", _afterSrcNodeChange);
		request.setAttribute("alloy:textboxlist:afterStringsChange", _afterStringsChange);
		request.setAttribute("alloy:textboxlist:afterSuppressInputUpdateChange", _afterSuppressInputUpdateChange);
		request.setAttribute("alloy:textboxlist:afterTabIndexChange", _afterTabIndexChange);
		request.setAttribute("alloy:textboxlist:afterTextboxBlur", _afterTextboxBlur);
		request.setAttribute("alloy:textboxlist:afterTextboxChange", _afterTextboxChange);
		request.setAttribute("alloy:textboxlist:afterTextboxFocus", _afterTextboxFocus);
		request.setAttribute("alloy:textboxlist:afterTextboxKey", _afterTextboxKey);
		request.setAttribute("alloy:textboxlist:afterTypeAhead", _afterTypeAhead);
		request.setAttribute("alloy:textboxlist:afterTypeAheadChange", _afterTypeAheadChange);
		request.setAttribute("alloy:textboxlist:afterTypeAheadDelayChange", _afterTypeAheadDelayChange);
		request.setAttribute("alloy:textboxlist:afterUniqueNameChange", _afterUniqueNameChange);
		request.setAttribute("alloy:textboxlist:afterUnmatchedItemSelect", _afterUnmatchedItemSelect);
		request.setAttribute("alloy:textboxlist:afterUseARIAChange", _afterUseARIAChange);
		request.setAttribute("alloy:textboxlist:afterVisibleChange", _afterVisibleChange);
		request.setAttribute("alloy:textboxlist:afterContentUpdate", _afterContentUpdate);
		request.setAttribute("alloy:textboxlist:afterRender", _afterRender);
		request.setAttribute("alloy:textboxlist:afterWidthChange", _afterWidthChange);
		request.setAttribute("alloy:textboxlist:onAlwaysShowContainerChange", _onAlwaysShowContainerChange);
		request.setAttribute("alloy:textboxlist:onApplyLocalFilterChange", _onApplyLocalFilterChange);
		request.setAttribute("alloy:textboxlist:onAutoHighlightChange", _onAutoHighlightChange);
		request.setAttribute("alloy:textboxlist:onBoundingBoxChange", _onBoundingBoxChange);
		request.setAttribute("alloy:textboxlist:onButtonChange", _onButtonChange);
		request.setAttribute("alloy:textboxlist:onContainerCollapse", _onContainerCollapse);
		request.setAttribute("alloy:textboxlist:onContainerExpand", _onContainerExpand);
		request.setAttribute("alloy:textboxlist:onContainerPopulate", _onContainerPopulate);
		request.setAttribute("alloy:textboxlist:onContentBoxChange", _onContentBoxChange);
		request.setAttribute("alloy:textboxlist:onCssClassChange", _onCssClassChange);
		request.setAttribute("alloy:textboxlist:onDataError", _onDataError);
		request.setAttribute("alloy:textboxlist:onDataRequest", _onDataRequest);
		request.setAttribute("alloy:textboxlist:onDataReturn", _onDataReturn);
		request.setAttribute("alloy:textboxlist:onDataSourceChange", _onDataSourceChange);
		request.setAttribute("alloy:textboxlist:onDataSourceTypeChange", _onDataSourceTypeChange);
		request.setAttribute("alloy:textboxlist:onDelimCharChange", _onDelimCharChange);
		request.setAttribute("alloy:textboxlist:onDestroy", _onDestroy);
		request.setAttribute("alloy:textboxlist:onDestroyedChange", _onDestroyedChange);
		request.setAttribute("alloy:textboxlist:onDisabledChange", _onDisabledChange);
		request.setAttribute("alloy:textboxlist:onFocusedChange", _onFocusedChange);
		request.setAttribute("alloy:textboxlist:onForceSelectionChange", _onForceSelectionChange);
		request.setAttribute("alloy:textboxlist:onHeightChange", _onHeightChange);
		request.setAttribute("alloy:textboxlist:onHideClassChange", _onHideClassChange);
		request.setAttribute("alloy:textboxlist:onIdChange", _onIdChange);
		request.setAttribute("alloy:textboxlist:onInit", _onInit);
		request.setAttribute("alloy:textboxlist:onInitializedChange", _onInitializedChange);
		request.setAttribute("alloy:textboxlist:onInputChange", _onInputChange);
		request.setAttribute("alloy:textboxlist:onItemArrowFrom", _onItemArrowFrom);
		request.setAttribute("alloy:textboxlist:onItemArrowTo", _onItemArrowTo);
		request.setAttribute("alloy:textboxlist:onItemMouseOut", _onItemMouseOut);
		request.setAttribute("alloy:textboxlist:onItemMouseOver", _onItemMouseOver);
		request.setAttribute("alloy:textboxlist:onItemSelect", _onItemSelect);
		request.setAttribute("alloy:textboxlist:onMatchKeyChange", _onMatchKeyChange);
		request.setAttribute("alloy:textboxlist:onMaxResultsDisplayedChange", _onMaxResultsDisplayedChange);
		request.setAttribute("alloy:textboxlist:onMinQueryLengthChange", _onMinQueryLengthChange);
		request.setAttribute("alloy:textboxlist:onQueryDelayChange", _onQueryDelayChange);
		request.setAttribute("alloy:textboxlist:onQueryIntervalChange", _onQueryIntervalChange);
		request.setAttribute("alloy:textboxlist:onQueryMatchCaseChange", _onQueryMatchCaseChange);
		request.setAttribute("alloy:textboxlist:onQueryMatchContainsChange", _onQueryMatchContainsChange);
		request.setAttribute("alloy:textboxlist:onQueryQuestionMarkChange", _onQueryQuestionMarkChange);
		request.setAttribute("alloy:textboxlist:onRenderChange", _onRenderChange);
		request.setAttribute("alloy:textboxlist:onRenderedChange", _onRenderedChange);
		request.setAttribute("alloy:textboxlist:onSchemaChange", _onSchemaChange);
		request.setAttribute("alloy:textboxlist:onSchemaTypeChange", _onSchemaTypeChange);
		request.setAttribute("alloy:textboxlist:onSelectionEnforce", _onSelectionEnforce);
		request.setAttribute("alloy:textboxlist:onSrcNodeChange", _onSrcNodeChange);
		request.setAttribute("alloy:textboxlist:onStringsChange", _onStringsChange);
		request.setAttribute("alloy:textboxlist:onSuppressInputUpdateChange", _onSuppressInputUpdateChange);
		request.setAttribute("alloy:textboxlist:onTabIndexChange", _onTabIndexChange);
		request.setAttribute("alloy:textboxlist:onTextboxBlur", _onTextboxBlur);
		request.setAttribute("alloy:textboxlist:onTextboxChange", _onTextboxChange);
		request.setAttribute("alloy:textboxlist:onTextboxFocus", _onTextboxFocus);
		request.setAttribute("alloy:textboxlist:onTextboxKey", _onTextboxKey);
		request.setAttribute("alloy:textboxlist:onTypeAhead", _onTypeAhead);
		request.setAttribute("alloy:textboxlist:onTypeAheadChange", _onTypeAheadChange);
		request.setAttribute("alloy:textboxlist:onTypeAheadDelayChange", _onTypeAheadDelayChange);
		request.setAttribute("alloy:textboxlist:onUniqueNameChange", _onUniqueNameChange);
		request.setAttribute("alloy:textboxlist:onUnmatchedItemSelect", _onUnmatchedItemSelect);
		request.setAttribute("alloy:textboxlist:onUseARIAChange", _onUseARIAChange);
		request.setAttribute("alloy:textboxlist:onVisibleChange", _onVisibleChange);
		request.setAttribute("alloy:textboxlist:onContentUpdate", _onContentUpdate);
		request.setAttribute("alloy:textboxlist:onRender", _onRender);
		request.setAttribute("alloy:textboxlist:onWidthChange", _onWidthChange);
	}
