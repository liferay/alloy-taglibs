...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:thumb-rating:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:thumb-rating:disabled")));
java.lang.Object elements = (java.lang.Object)request.getAttribute("alloy:thumb-rating:elements");
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:thumb-rating:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:thumb-rating:initialized")));
...
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:thumb-rating:rendered")));
