...
boolean autoHide = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:resize:autoHide")));
...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:resize:destroyed")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:resize:initialized")));
...
boolean preserveRatio = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:resize:preserveRatio")));
boolean proxy = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:resize:proxy")));
java.lang.String proxyEl = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:resize:proxyEl"));
boolean resizing = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:resize:resizing")));
...
boolean wrap = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:resize:wrap")));
