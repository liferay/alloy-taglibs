...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:rating:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:rating:disabled")));
java.lang.Object elements = (java.lang.Object)request.getAttribute("alloy:rating:elements");
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:rating:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:rating:initialized")));
...
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:rating:rendered")));
