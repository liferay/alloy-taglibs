...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:date-picker-select:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:date-picker-select:disabled")));
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:date-picker-select:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:date-picker-select:initialized")));
...
boolean nullableDay = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:date-picker-select:nullableDay")));
boolean nullableMonth = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:date-picker-select:nullableMonth")));
boolean nullableYear = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:date-picker-select:nullableYear")));
...
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:date-picker-select:rendered")));
