...
boolean checked = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tree-node-task:checked")));
...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tree-node-task:destroyed")));
boolean draggable = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tree-node-task:draggable")), true);
boolean expanded = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tree-node-task:expanded")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tree-node-task:initialized")));
...
boolean loaded = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tree-node-task:loaded")));
boolean loading = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tree-node-task:loading")));
