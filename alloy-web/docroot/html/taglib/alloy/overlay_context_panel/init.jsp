...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context-panel:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context-panel:disabled")));
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:overlay-context-panel:fillHeight");
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context-panel:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context-panel:initialized")));
boolean preventOverlap = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context-panel:preventOverlap")));
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:overlay-context-panel:render");
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context-panel:rendered")));
boolean shim = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context-panel:shim")));
...
boolean visible = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context-panel:visible")));
