...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:image-viewer:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:image-viewer:disabled")));
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:image-viewer:fillHeight");
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:image-viewer:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:image-viewer:initialized")));
...
boolean loading = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:image-viewer:loading")));
...
boolean preloadAllImages = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:image-viewer:preloadAllImages")));
boolean preventOverlap = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:image-viewer:preventOverlap")));
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:image-viewer:render");
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:image-viewer:rendered")));
boolean shim = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:image-viewer:shim")));
