...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-mask:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-mask:disabled")));
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:overlay-mask:fillHeight");
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-mask:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-mask:initialized")));
java.lang.Number opacity = GetterUtil.getNumber(String.valueOf(request.getAttribute("alloy:overlay-mask:opacity")), 0.5);
boolean preventOverlap = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-mask:preventOverlap")));
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:overlay-mask:render");
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-mask:rendered")));
boolean shim = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-mask:shim")));
...
boolean visible = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-mask:visible")));
