...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context:disabled")));
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:overlay-context:fillHeight");
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context:initialized")));
boolean preventOverlap = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context:preventOverlap")));
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:overlay-context:render");
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context:rendered")));
boolean shim = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context:shim")));
...
boolean visible = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:overlay-context:visible")));
