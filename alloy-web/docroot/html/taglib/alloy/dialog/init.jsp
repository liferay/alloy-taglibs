...
boolean collapsed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:collapsed")));
boolean collapsible = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:collapsible")));
...
boolean destroyOnClose = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:destroyOnClose")));
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:disabled")));
...
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:initialized")));
boolean modal = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:modal")));
boolean preventOverlap = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:preventOverlap")));
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:dialog:render");
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:rendered")));
...
boolean shim = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:dialog:shim")));
