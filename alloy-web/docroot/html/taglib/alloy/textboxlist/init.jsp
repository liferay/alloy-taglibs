...
<%
boolean alwaysShowContainer = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:alwaysShowContainer")));
...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:disabled")));
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:focused")));
boolean forceSelection = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:forceSelection")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:initialized")));
...
boolean queryMatchCase = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:queryMatchCase")));
boolean queryMatchContains = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:queryMatchContains")));
...
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:rendered")));
...
boolean suppressInputUpdate = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:suppressInputUpdate")));
java.lang.Number tabIndex = GetterUtil.getNumber(String.valueOf(request.getAttribute("alloy:textboxlist:tabIndex")), 0);
boolean typeAhead = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:textboxlist:typeAhead")));
