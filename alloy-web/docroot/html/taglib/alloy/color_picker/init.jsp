...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:color-picker:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:color-picker:disabled")));
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:color-picker:fillHeight");
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:color-picker:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:color-picker:initialized")));
boolean preventOverlap = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:color-picker:preventOverlap")));
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:color-picker:render");
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:color-picker:rendered")));
boolean shim = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:color-picker:shim")));
...
boolean visible = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:color-picker:visible")));
