...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:calendar:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:calendar:disabled")));
...
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:calendar:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:calendar:initialized")));
...
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:calendar:rendered")));
boolean selectMultipleDates = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:calendar:selectMultipleDates")));
...
boolean showNextMonth = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:calendar:showNextMonth")));
boolean showOtherMonth = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:calendar:showOtherMonth")), true);
boolean showPrevMonth = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:calendar:showPrevMonth")));
