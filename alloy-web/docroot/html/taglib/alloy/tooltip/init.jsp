...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tooltip:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tooltip:disabled")));
java.lang.Object fillHeight = (java.lang.Object)request.getAttribute("alloy:tooltip:fillHeight");
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tooltip:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tooltip:initialized")));
boolean preventOverlap = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tooltip:preventOverlap")));
java.lang.Object render = (java.lang.Object)request.getAttribute("alloy:tooltip:render");
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tooltip:rendered")));
boolean shim = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tooltip:shim")));
...
boolean title = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tooltip:title")));
...
boolean visible = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:tooltip:visible")));
