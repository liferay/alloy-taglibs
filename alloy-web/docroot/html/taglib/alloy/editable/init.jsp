...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:editable:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:editable:disabled")));
java.lang.String eventType = GetterUtil.getString((java.lang.String)request.getAttribute("alloy:editable:eventType"), "click");
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:editable:focused")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:editable:initialized")));
...
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("alloy:editable:rendered")));
