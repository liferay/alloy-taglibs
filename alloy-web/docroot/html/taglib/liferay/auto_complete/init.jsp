...
boolean destroyed = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay:auto-complete:destroyed")));
boolean disabled = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay:auto-complete:disabled")));
boolean focused = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay:auto-complete:focused")));
boolean forceSelection = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay:auto-complete:forceSelection")));
...
boolean initialized = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay:auto-complete:initialized")));
...
boolean queryMatchCase = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay:auto-complete:queryMatchCase")));
boolean queryMatchContains = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay:auto-complete:queryMatchContains")));
...
boolean rendered = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay:auto-complete:rendered")));
...
boolean suppressInputUpdate = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay:auto-complete:suppressInputUpdate")));
java.lang.Number tabIndex = GetterUtil.getNumber(String.valueOf(request.getAttribute("liferay:auto-complete:tabIndex")), 0);
boolean typeAhead = GetterUtil.getBoolean(String.valueOf(request.getAttribute("liferay:auto-complete:typeAhead")));
